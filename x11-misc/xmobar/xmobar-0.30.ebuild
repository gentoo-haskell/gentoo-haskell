...
#hackport: flags: -all_extensions,+with_threaded,+with_utf8,with_iwlib:wifi,with_alsa:alsa,with_xft:xft,with_datezone:timezone,with_dbus:dbus,with_mpd:mpd,with_inotify:inotify,with_mpris:mpris,with_xpm:xpm,with_rtsopts:rtsopts,with_uvmeter:uvmeter,with_weather:weather
...
SLOT="0/${PV}"
KEYWORDS="~amd64 ~x86"
IUSE="alsa dbus inotify mpd mpris timezone wifi +rtsopts uvmeter +weather xft xpm"
...
RDEPEND="dev-haskell/async:=[profile?]
	...
	mpd? ( >=dev-haskell/libmpd-0.9.0.6:=[profile?] )
