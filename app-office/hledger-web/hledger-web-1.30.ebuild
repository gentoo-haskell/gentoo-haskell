...
RDEPEND=">=app-office/hledger-1.30:=[profile?] <app-office/hledger-1.31:=[profile?]
	...
	>=dev-haskell/hledger-lib-1.30:=[profile?] <dev-haskell/hledger-lib-1.31:=[profile?]
	dev-haskell/hspec:=[profile?]
	dev-haskell/http-client:=[profile?]
	dev-haskell/http-conduit:=[profile?]
	dev-haskell/http-types:=[profile?]
	>=dev-haskell/megaparsec-7.0.0:=[profile?] <dev-haskell/megaparsec-9.5:=[profile?]
