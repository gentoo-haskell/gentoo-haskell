...
RDEPEND=">=app-editors/leksah-server-0.16.1.0:=[profile?] <app-editors/leksah-server-0.17:=[profile?]
	...
	>=dev-haskell/cabal-1.24.0.0:=[profile?] <dev-haskell/cabal-1.25:=[profile?]
	...
	>=dev-haskell/quickcheck-2.4.2:2=[profile?] <dev-haskell/quickcheck-2.10:2=[profile?]
	...
	>=dev-lang/ghc-6.10.1:=[profile?] <dev-lang/ghc-8.1:=[profile?]
	>=dev-lang/ghc-7.8.2:=
