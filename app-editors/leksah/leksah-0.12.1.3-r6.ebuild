...
RDEPEND=">=app-editors/leksah-server-0.12.1.2:=[profile?]
		...
		>=dev-haskell/gio-0.12.2:${GTK_MAJ_VER}=[profile?]
		<dev-haskell/gio-0.13:${GTK_MAJ_VER}=[profile?]
		>=dev-haskell/glib-0.10:${GTK_MAJ_VER}=[profile?]
		...
		>=dev-haskell/gtksourceview2-0.10.0:${GTK_MAJ_VER}=[profile?]
		<dev-haskell/gtksourceview2-0.13:${GTK_MAJ_VER}=[profile?]
