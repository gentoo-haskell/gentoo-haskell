...
RDEPEND=">=app-editors/leksah-server-0.14.3.0:=[profile?] <app-editors/leksah-server-0.15:=[profile?]
	...
	>=dev-haskell/ltk-0.14.3.0:=[profile?] <dev-haskell/ltk-0.15:=[profile?]
...
src_prepare() {
	...
	cabal_chdeps \
		...
		'QuickCheck >=2.4.2 && <2.8' 'QuickCheck >=2.4.2'
}
