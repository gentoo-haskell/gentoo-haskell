...
RDEPEND=">=app-editors/leksah-server-0.15.0.6:=[profile?] <app-editors/leksah-server-0.16:=[profile?]
	...
	>=dev-haskell/gtk3-0.13.9:=[profile?] <dev-haskell/gtk3-0.15:=[profile?]
	...
	>=dev-haskell/ltk-0.15.0.2:=[profile?] <dev-haskell/ltk-0.16:=[profile?]
