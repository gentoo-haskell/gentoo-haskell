...
SLOT="0/${PV}"
KEYWORDS="~amd64 ~x86"
IUSE="ghcapi gtk profiling +testing +vty"
...
RDEPEND=">=dev-haskell/binary-0.5:=[profile?]
	...
	>=dev-haskell/fingertree-0:=[profile?] <dev-haskell/fingertree-0.2:=[profile?]
	...
	testing? ( >=dev-haskell/quickcheck-2.7:=[profile?] <dev-haskell/quickcheck-2.8:=[profile?]
			dev-haskell/random:=[profile?] )
	vty? ( >=dev-haskell/vty-4.7.4:=[profile?] <dev-haskell/vty-5:=[profile?] )
"
DEPEND="${RDEPEND}
	dev-haskell/alex
