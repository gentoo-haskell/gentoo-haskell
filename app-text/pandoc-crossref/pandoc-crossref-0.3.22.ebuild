...
RDEPEND=">=dev-haskell/data-default-0.4:=[profile?] <dev-haskell/data-default-0.9:=[profile?]
	...
	>=dev-haskell/open-browser-0.2:=[profile?] <dev-haskell/open-browser-0.4:=[profile?]
	>=dev-haskell/optparse-applicative-0.13:=[profile?] <dev-haskell/optparse-applicative-0.20:=[profile?]
	>=dev-haskell/pandoc-3.8.2:=[profile?] <dev-haskell/pandoc-3.9:=[profile?]
