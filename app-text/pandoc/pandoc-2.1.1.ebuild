...
SLOT="0/${PV}"
KEYWORDS="~amd64 ~x86"
IUSE="embed_data_files +network-uri static trypandoc weigh-pandoc"
...
RDEPEND=">=dev-haskell/aeson-0.7:=[profile?] <dev-haskell/aeson-1.3:=[profile?]
	...
	>=dev-haskell/hslua-0.9.5:=[profile?] <dev-haskell/hslua-0.10:=[profile?]
	...
	>=dev-haskell/skylighting-0.5.1:=[profile?] <dev-haskell/skylighting-0.7:=[profile?]
	>=dev-haskell/split-0.2:=[profile?] <dev-haskell/split-0.3:=[profile?]
	>=dev-haskell/syb-0.1:=[profile?] <dev-haskell/syb-0.8:=[profile?]
	>=dev-haskell/tagsoup-0.14.2:=[profile?] <dev-haskell/tagsoup-0.15:=[profile?]
