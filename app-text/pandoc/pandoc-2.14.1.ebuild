...
RDEPEND=">=dev-haskell/aeson-0.7:=[profile?] <dev-haskell/aeson-1.6:=[profile?]
	...
	>=dev-haskell/citeproc-0.4.1:=[profile?] <dev-haskell/citeproc-0.4.2:=[profile?]
	>=dev-haskell/commonmark-0.2.1:=[profile?] <dev-haskell/commonmark-0.3:=[profile?]
	>=dev-haskell/commonmark-extensions-0.2.1.2:=[profile?] <dev-haskell/commonmark-extensions-0.3:=[profile?]
	...
	>=dev-haskell/skylighting-0.11:=[profile?] <dev-haskell/skylighting-0.12:=[profile?]
	>=dev-haskell/skylighting-core-0.11:=[profile?] <dev-haskell/skylighting-core-0.12:=[profile?]
	...
	>=dev-haskell/texmath-0.12.3:=[profile?] <dev-haskell/texmath-0.12.4:=[profile?]
