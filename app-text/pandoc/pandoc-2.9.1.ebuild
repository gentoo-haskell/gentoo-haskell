...
LICENSE="GPL-2"
SLOT="0/${PV}"
KEYWORDS="" # haddock-library-1.8.0 had no KEYWORDS
...
RDEPEND=">=dev-haskell/aeson-0.7:=[profile?] <dev-haskell/aeson-1.5:=[profile?]
	...
	>=dev-haskell/doclayout-0.2.0.1:=[profile?] <dev-haskell/doclayout-0.3:=[profile?]
	...
	>=dev-haskell/foundation-0.0.23:=[profile?]
	>=dev-haskell/glob-0.7:=[profile?] <dev-haskell/glob-0.11:=[profile?]
	>=dev-haskell/haddock-library-1.8:=[profile?] <dev-haskell/haddock-library-1.9:=[profile?]
	...
	>=dev-haskell/jira-wiki-markup-1.0:=[profile?] <dev-haskell/jira-wiki-markup-1.1:=[profile?]
	...
	>=dev-haskell/skylighting-0.8.3:=[profile?] <dev-haskell/skylighting-0.9:=[profile?]
	>=dev-haskell/skylighting-core-0.8.3:=[profile?] <dev-haskell/skylighting-core-0.9:=[profile?]
	...
	>=dev-haskell/texmath-0.12:=[profile?] <dev-haskell/texmath-0.13:=[profile?]
