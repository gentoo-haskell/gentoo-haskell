...
RDEPEND="
	...
	>=dev-haskell/citeproc-0.8.0.1:=[profile?] <dev-haskell/citeproc-0.9:=[profile?]
	...
	>=dev-haskell/gridtables-0.0.3:=[profile?] <dev-haskell/gridtables-0.1:=[profile?]
	>=dev-haskell/haddock-library-1.10:=[profile?] <dev-haskell/haddock-library-1.12:=[profile?]
	>=dev-haskell/hslua-2.2.1:=[profile?] <dev-haskell/hslua-2.3:=[profile?]
	>=dev-haskell/hslua-aeson-2.2.1:=[profile?] <dev-haskell/hslua-aeson-2.3:=[profile?]
	>=dev-haskell/hslua-module-doclayout-1.0.4:=[profile?] <dev-haskell/hslua-module-doclayout-1.1:=[profile?]
	>=dev-haskell/hslua-module-path-1.0.3:=[profile?] <dev-haskell/hslua-module-path-1.1:=[profile?]
	...
	>=dev-haskell/pandoc-lua-marshal-0.1.7:=[profile?] <dev-haskell/pandoc-lua-marshal-0.2:=[profile?]
	...
	>=dev-haskell/skylighting-core-0.13:=[profile?] <dev-haskell/skylighting-core-0.14:=[profile?]
	...
	>=dev-haskell/texmath-0.12.5.1:=[profile?] <dev-haskell/texmath-0.12.6:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? (
		>=dev-haskell/diff-0.2 <dev-haskell/diff-0.5
