...
RDEPEND=">=dev-haskell/aeson-0.7:=[profile?] <dev-haskell/aeson-1.6:=[profile?]
	...
	>=dev-haskell/citeproc-0.3.0.7:=[profile?] <dev-haskell/citeproc-0.4:=[profile?]
	...
	>=dev-haskell/jira-wiki-markup-1.3.3:=[profile?] <dev-haskell/jira-wiki-markup-1.4:=[profile?]
	...
	>=dev-haskell/skylighting-0.10.4:=[profile?] <dev-haskell/skylighting-0.11:=[profile?]
	>=dev-haskell/skylighting-core-0.10.4:=[profile?] <dev-haskell/skylighting-core-0.11:=[profile?]
