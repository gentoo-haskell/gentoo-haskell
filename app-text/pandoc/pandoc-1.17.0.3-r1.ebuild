...
inherit haskell-cabal readme.gentoo-r1
...
RDEPEND=">=dev-haskell/aeson-0.7.0.5:=[profile?] <dev-haskell/aeson-0.12:=[profile?]
	...
	>=dev-haskell/tagsoup-0.13.7:=[profile?] <dev-haskell/tagsoup-0.14:=[profile?]
	>=dev-haskell/temporary-1.1:=[profile?] <dev-haskell/temporary-1.3:=[profile?]
	>=dev-haskell/texmath-0.8.4.1:=[profile?] <dev-haskell/texmath-0.9:=[profile?]
...
DOC_CONTENTS="
To use some writes you wil also need to install
additional packages:
