...
RDEPEND=">=dev-haskell/aeson-0.7:=[profile?] <dev-haskell/aeson-2.1:=[profile?]
	...
	>=dev-haskell/citeproc-0.6:=[profile?] <dev-haskell/citeproc-0.7:=[profile?]
	>=dev-haskell/commonmark-0.2.1.1:=[profile?] <dev-haskell/commonmark-0.3:=[profile?]
	>=dev-haskell/commonmark-extensions-0.2.2:=[profile?] <dev-haskell/commonmark-extensions-0.3:=[profile?]
	>=dev-haskell/commonmark-pandoc-0.2.1.1:=[profile?] <dev-haskell/commonmark-pandoc-0.3:=[profile?]
	...
	>=dev-haskell/hslua-2.0.1:=[profile?] <dev-haskell/hslua-2.1:=[profile?]
	...
	>=dev-haskell/ipynb-0.1.0.2:=[profile?] <dev-haskell/ipynb-0.2:=[profile?]
	...
	>=dev-haskell/skylighting-0.12.1:=[profile?] <dev-haskell/skylighting-0.13:=[profile?]
	>=dev-haskell/skylighting-core-0.12.1:=[profile?] <dev-haskell/skylighting-core-0.13:=[profile?]
	...
	>=dev-haskell/texmath-0.12.3.2:=[profile?] <dev-haskell/texmath-0.12.4:=[profile?]
