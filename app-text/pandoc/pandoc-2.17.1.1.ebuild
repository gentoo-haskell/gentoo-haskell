...
RDEPEND=">=dev-haskell/aeson-0.7:=[profile?] <dev-haskell/aeson-2.1:=[profile?]
	...
	>=dev-haskell/citeproc-0.6.0.1:=[profile?] <dev-haskell/citeproc-0.7:=[profile?]
	>=dev-haskell/commonmark-0.2.1.1:=[profile?] <dev-haskell/commonmark-0.3:=[profile?]
	>=dev-haskell/commonmark-extensions-0.2.3:=[profile?] <dev-haskell/commonmark-extensions-0.3:=[profile?]
	...
	>=dev-haskell/doclayout-0.3.1.1:=[profile?] <dev-haskell/doclayout-0.4:=[profile?]
	...
	>=dev-haskell/hslua-2.1:=[profile?] <dev-haskell/hslua-2.2:=[profile?]
	>=dev-haskell/hslua-aeson-2.1:=[profile?] <dev-haskell/hslua-aeson-2.2:=[profile?]
	...
	>=dev-haskell/pandoc-lua-marshal-0.1.3.1:=[profile?] <dev-haskell/pandoc-lua-marshal-0.2:=[profile?]
	...
	>=dev-haskell/skylighting-0.12.2:=[profile?] <dev-haskell/skylighting-0.13:=[profile?]
	>=dev-haskell/skylighting-core-0.12.2:=[profile?] <dev-haskell/skylighting-core-0.13:=[profile?]
	...
	>=dev-haskell/texmath-0.12.4:=[profile?] <dev-haskell/texmath-0.12.5:=[profile?]
