...
PATCHES=(
	"${FILESDIR}/${PN}-2.18.3-remove-ghc-9_6-conditional.patch"
)

RDEPEND="
	>=dev-haskell/async-2.0.2:=[profile?] <dev-haskell/async-2.3:=[profile?]
	>=dev-haskell/attoparsec-0.13.0.1:=[profile?] <dev-haskell/attoparsec-0.15:=[profile?]
	...
	>=dev-haskell/data-default-class-0.1.2.0:=[profile?] <dev-haskell/data-default-class-0.1.3:=[profile?]
	...
	>=dev-haskell/strict-identity-0.1:=[profile?] <dev-haskell/strict-identity-0.2:=[profile?]
	...
	>=dev-haskell/tls-2.0.6:=[profile?] <dev-haskell/tls-2.1:=[profile?]
