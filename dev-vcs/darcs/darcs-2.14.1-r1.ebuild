...
RDEPEND=">=dev-haskell/async-2.0.2:=[profile?] <dev-haskell/async-2.3:=[profile?]
	...
	>=dev-haskell/fgl-5.5.2.3:=[profile?] <dev-haskell/fgl-5.7:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/cmdargs-0.10.10 <dev-haskell/cmdargs-0.11
		...
		>=dev-haskell/quickcheck-2.8.2 <dev-haskell/quickcheck-2.12
		>=dev-haskell/shelly-1.6.8 <dev-haskell/shelly-1.9
