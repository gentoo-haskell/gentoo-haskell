...
RESTRICT=test # QC-2.10 incompatible
...
RDEPEND=">=dev-haskell/async-2.0.2:=[profile?]
	...
	>=dev-haskell/graphviz-2999.18.1:=[profile?]
	...
	>=dev-haskell/zip-archive-0.3:=[profile?] <dev-haskell/zip-archive-0.4:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/cmdargs-0.10.10
...
src_prepare() {
	...
	cabal_chdeps \
		...
		'fgl               >= 5.5.2.3 && < 5.6' 'fgl               >= 5.5.2.3' \
		'graphviz          >= 2999.18.1 && < 2999.20' 'graphviz          >= 2999.18.1' \
		'base         >= 4.9 && < 4.12' 'base         >= 4.9' \
		'cmdargs      >= 0.10.10 && < 0.11' 'cmdargs      >= 0.10.10' \
		'FindBin      >= 0.0.5 && < 0.1' 'FindBin      >= 0.0.5' \
		'HUnit        >= 1.3 && < 1.7' 'HUnit        >= 1.3' \
		'QuickCheck   >= 2.8.2 && < 2.11' 'QuickCheck   >= 2.8.2' \
		'shelly       >= 1.6.8 && < 1.7' 'shelly       >= 1.6.8' \
		'split        >= 0.2.2 && < 0.3' 'split        >= 0.2.2' \
		'test-framework             >= 0.8.1.1 && < 0.9' 'test-framework             >= 0.8.1.1' \
		'test-framework-hunit       >= 0.3.0.2 && < 0.4' 'test-framework-hunit       >= 0.3.0.2' \
		'test-framework-quickcheck2 >= 0.3.0.3 && < 0.4' 'test-framework-quickcheck2 >= 0.3.0.3'
}
