...
RDEPEND=">=dev-haskell/brick-0.16:= <dev-haskell/brick-0.42:=
	...
	>=dev-haskell/vector-algorithms-0.6.0.4:=
	>=dev-haskell/vty-5.13:= <dev-haskell/vty-5.25:=
	>=dev-lang/ghc-8.0.2:=
"
DEPEND="${RDEPEND}
...
src_prepare() {
	...
	cabal_chdeps \
		...
		'vector-algorithms >= 0.6.0.4 && < 0.8' 'vector-algorithms >= 0.6.0.4'
}
