...
# hard code this hackish url, unlikely to be used again
# do it properly once the final release is out, based on the 0.9.12.1 ebuild
SRC_URI="http://code.haskell.org/~pgavin/gtk2hs-0.10.0/gtk2hs-0.10.0-rc-20090119.tar.gz"
