...
RDEPEND=">=dev-haskell/attoparsec-0.13:=[profile?] <dev-haskell/attoparsec-0.15:=[profile?]
	...
	>=dev-lang/ghc-8.8.1:=
	>=dev-haskell/aeson-1.3:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	executable? ( >=dev-haskell/optparse-applicative-0.14:=[profile?]
			...
			>=dev-haskell/pipes-text-0.0:=[profile?] )
"
DEPEND="${RDEPEND}
	>=dev-haskell/cabal-3.0.0.0
	test? ( >=dev-haskell/tasty-1.1 <dev-haskell/tasty-1.5
		>=dev-haskell/tasty-hedgehog-0.2 <dev-haskell/tasty-hedgehog-2
		>=dev-haskell/tasty-hunit-0.10 <dev-haskell/tasty-hunit-0.11
		|| ( ( >=dev-haskell/hedgehog-0.6 <dev-haskell/hedgehog-1.3 )
			|| ( ( >=dev-haskell/hedgehog-1.3 <dev-haskell/hedgehog-1.4 )
