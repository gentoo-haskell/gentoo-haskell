...
RDEPEND=">=dev-haskell/aeson-0.11:=[profile?] <dev-haskell/aeson-3:=[profile?]
	...
	>=dev-haskell/dlist-0.8:=[profile?] <dev-haskell/dlist-2:=[profile?]
	...
	>=dev-haskell/hashable-1:=[profile?] <dev-haskell/hashable-1.6:=[profile?]
	>=dev-haskell/html-entity-map-0.1:=[profile?] <dev-haskell/html-entity-map-0.2:=[profile?]
	>=dev-haskell/lucid-2.9.13:=[profile?] <dev-haskell/lucid-3:=[profile?]
	...
	>=dev-haskell/modern-uri-0.3.4.4:=[profile?] <dev-haskell/modern-uri-0.4:=[profile?]
	>=dev-haskell/parser-combinators-0.4:=[profile?] <dev-haskell/parser-combinators-2:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/hspec-2 <dev-haskell/hspec-3
		>=dev-haskell/hspec-megaparsec-2 <dev-haskell/hspec-megaparsec-3
