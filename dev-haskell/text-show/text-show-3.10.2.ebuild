...
RDEPEND="
	>=dev-haskell/base-compat-batteries-0.11:=[profile?] <dev-haskell/base-compat-batteries-0.14:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? (
		>=dev-haskell/base-orphans-0.8.5 <dev-haskell/base-orphans-0.10
