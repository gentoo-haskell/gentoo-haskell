...
RDEPEND=">=dev-haskell/base-compat-0.8.1:=[profile?] <dev-haskell/base-compat-1:=[profile?]
	...
	>=dev-haskell/generic-deriving-1.8:=[profile?] <dev-haskell/generic-deriving-2:=[profile?]
	>=dev-haskell/nats-0.1:=[profile?] <dev-haskell/nats-2:=[profile?]
	>=dev-haskell/semigroups-0.16.1:=[profile?] <dev-haskell/semigroups-1:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/base-compat-0.8.2 <dev-haskell/base-compat-1
		...
		>=dev-haskell/bifunctors-5 <dev-haskell/bifunctors-6
		>=dev-haskell/generic-deriving-1.8.0 <dev-haskell/generic-deriving-2
		...
		>=dev-haskell/tagged-0.8.1 <dev-haskell/tagged-1
		>=dev-haskell/transformers-compat-0.3 <dev-haskell/transformers-compat-1 )
"
