...
RDEPEND=">=dev-haskell/base-compat-0.10.5:=[profile?] <dev-haskell/base-compat-0.14:=[profile?]
	...
	>=dev-haskell/servant-client-core-0.20:=[profile?] <dev-haskell/servant-client-core-0.21:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( dev-haskell/aeson
		...
		>=dev-haskell/servant-server-0.20 <dev-haskell/servant-server-0.21
