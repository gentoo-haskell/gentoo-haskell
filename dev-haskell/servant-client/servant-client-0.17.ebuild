...
RDEPEND=">=dev-haskell/base-compat-0.10.5:=[profile?] <dev-haskell/base-compat-0.12:=[profile?]
	...
	>=dev-haskell/servant-client-core-0.17:=[profile?] <dev-haskell/servant-client-core-0.17.1:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( dev-haskell/aeson
		...
		>=dev-haskell/servant-server-0.17 <dev-haskell/servant-server-0.18
