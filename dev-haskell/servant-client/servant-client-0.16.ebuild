...
RDEPEND=">=dev-haskell/base-compat-0.10.5:=[profile?] <dev-haskell/base-compat-0.11:=[profile?]
	...
	>=dev-haskell/servant-0.16:=[profile?] <dev-haskell/servant-0.17:=[profile?]
	>=dev-haskell/servant-client-core-0.16:=[profile?] <dev-haskell/servant-client-core-0.16.1:=[profile?]
