...
RDEPEND=">=dev-haskell/base-compat-0.10.5:=[profile?] <dev-haskell/base-compat-0.11:=[profile?]
	...
	>=dev-haskell/servant-0.15:=[profile?] <dev-haskell/servant-0.16:=[profile?]
	>=dev-haskell/servant-client-core-0.15:=[profile?] <dev-haskell/servant-client-core-0.15.1:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( dev-haskell/aeson
		...
		>=dev-haskell/generics-sop-0.4.0.1 <dev-haskell/generics-sop-0.5
		>=dev-haskell/hspec-2.6.0 <dev-haskell/hspec-2.7
		dev-haskell/http-api-data
		>=dev-haskell/hunit-1.6.0.0 <dev-haskell/hunit-1.7
		dev-haskell/markdown-unlit
		>=dev-haskell/network-2.8.0.0 <dev-haskell/network-2.9
		>=dev-haskell/quickcheck-2.12.6.1 <dev-haskell/quickcheck-2.13
		>=dev-haskell/servant-server-0.15 <dev-haskell/servant-server-0.16
...
src_prepare() {
	...
	# As per http://hackage.haskell.org/package/servant-client-0.15/revisions/
	cabal_chdeps 'http-client           >= 0.5.13.1 && < 0.6' 'http-client >=0.5.13.1 && <0.7'
}
