...
RDEPEND="dev-haskell/aeson:=[profile?]
	...
	>=dev-haskell/http-common-0.7.2:=[profile?] <dev-haskell/http-common-0.8:=[profile?]
	>=dev-haskell/io-streams-1.1:=[profile?] <dev-haskell/io-streams-1.4:=[profile?]
