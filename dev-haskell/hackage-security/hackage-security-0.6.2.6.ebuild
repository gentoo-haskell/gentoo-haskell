...
# test? ( >=dev-haskell/quickcheck-2.11 <dev-haskell/quickcheck-2.16
# 	>=dev-haskell/tasty-1.1.0.4 <dev-haskell/tasty-1.6
...
# 	cabal-syntax? ( >=dev-haskell/cabal-3.7 <dev-haskell/cabal-3.14 ) )
