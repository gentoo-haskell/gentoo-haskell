...
LICENSE="BSD"
SLOT="0/${PV}"
#for now, sole package asking this is cabal-install-9999 (3.3)
#and <cabal-install-3 require <hackage-security-6
KEYWORDS=""
IUSE=""
...
RDEPEND=">=dev-haskell/base16-bytestring-0.1.1:=[profile?] <dev-haskell/base16-bytestring-0.2:=[profile?]
	...
	>=dev-lang/ghc-7.8.2:=
	|| ( ( >=dev-haskell/cabal-1.14 <dev-haskell/cabal-1.26 )
			( >=dev-haskell/cabal-2.0 <dev-haskell/cabal-2.6 )
			( >=dev-haskell/cabal-3.0 <dev-haskell/cabal-3.4 ) )
