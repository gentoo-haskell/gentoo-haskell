...
#hackport: flags: -mtl21,+use-network-uri,cabal-syntax:new-cabal-syntax
...
RDEPEND="
	...
	new-cabal-syntax? (
		>=dev-haskell/cabal-syntax-3.7:=[profile?] <dev-haskell/cabal-syntax-3.12:=[profile?]
	)
	!new-cabal-syntax? (
...
src_configure() {
	haskell-cabal_src_configure \
		$(cabal_flag new-cabal-syntax cabal-syntax) \
