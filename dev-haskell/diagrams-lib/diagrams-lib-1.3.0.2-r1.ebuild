...
RDEPEND=">=dev-haskell/active-0.2:=[profile?] <dev-haskell/active-0.3:=[profile?]
	...
	>=dev-haskell/fsnotify-0.2:=[profile?]
	...
	>=dev-haskell/lens-4.6:=[profile?] <dev-haskell/lens-4.13:=[profile?]
	>=dev-haskell/linear-1.11.3:=[profile?] <dev-haskell/linear-1.20:=[profile?]
	...
	>=dev-haskell/system-filepath-0.2:=[profile?] <dev-haskell/system-filepath-0.5:=[profile?]
...
src_prepare() {
	epatch "${FILESDIR}"/${PN}-1.3.0.2-filepath-0.2.patch
}
