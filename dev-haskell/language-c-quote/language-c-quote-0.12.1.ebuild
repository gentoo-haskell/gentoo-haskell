...
RDEPEND=">=dev-haskell/exception-mtl-0.3:=[profile?] <dev-haskell/exception-mtl-0.5:=[profile?]
	...
	>=dev-haskell/mainland-pretty-0.6:=[profile?] <dev-haskell/mainland-pretty-0.7:=[profile?]
	...
	>=dev-lang/ghc-7.4.1:=
	full-haskell-antiquotes? ( >=dev-haskell/haskell-src-meta-0.4:=[profile?] <dev-haskell/haskell-src-meta-0.9:=[profile?]
