...
RDEPEND="
	>=dev-haskell/binary-orphans-1.0.4:=[profile?] <dev-haskell/binary-orphans-1.1:=[profile?]
	...
	>=dev-lang/ghc-8.8.1:=
	|| (
		( >=dev-haskell/aeson-0.7.0.6 <dev-haskell/aeson-1.6 )
		( >=dev-haskell/aeson-2.0.0.0 <dev-haskell/aeson-2.2 )
	)
	dev-haskell/aeson:=[profile?]
	|| (
		( >=dev-haskell/text-1.2.0.6 <dev-haskell/text-1.3 )
