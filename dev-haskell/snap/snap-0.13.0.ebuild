...
RDEPEND=">=dev-haskell/aeson-0.6:=[profile?] <dev-haskell/aeson-0.7:=[profile?]
	...
	>=dev-haskell/lens-3.7.6:=[profile?] <dev-haskell/lens-3.10:=[profile?]
	...
	>=dev-haskell/mwc-random-0.8:=[profile?] <dev-haskell/mwc-random-0.13:=[profile?]
	>=dev-haskell/pwstore-fast-2.2:=[profile?] <dev-haskell/pwstore-fast-2.4:=[profile?]
	...
	>=dev-haskell/vector-algorithms-0.4:=[profile?] <dev-haskell/vector-algorithms-0.6:=[profile?]
