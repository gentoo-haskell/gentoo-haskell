...
RDEPEND=">=dev-haskell/aeson-0.6:=[profile?]
	...
	>=dev-haskell/snap-core-1.0.3:=[profile?] <dev-haskell/snap-core-1.1:=[profile?]
...
src_prepare() {
	...
	cabal_chdeps \
		...
		'heist                     >= 1.1      && < 1.2'  'heist		>= 1.1' \
		'lens                      >= 3.7.6    && < 4.18' 'lens			>= 3.7.6' \
		'map-syntax                >= 0.2      && < 0.4'  'map-syntax	>= 0.2' \
		'snap-server               >= 1.0      && < 1.2'  'snap-server  >= 1.0'
