...
RDEPEND=">=dev-haskell/data-fix-0.3.2:=[profile?] <dev-haskell/data-fix-0.4:=[profile?]
	...
	>=dev-haskell/hashable-1.4.2.0:=[profile?] <dev-haskell/hashable-1.5:=[profile?]
	...
	>=dev-haskell/th-abstraction-0.5.0.0:=[profile?] <dev-haskell/th-abstraction-0.7:=[profile?]
