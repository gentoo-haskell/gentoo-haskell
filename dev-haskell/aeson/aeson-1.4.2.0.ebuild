...
RDEPEND=">=dev-haskell/attoparsec-0.13.2.2:=[profile?] <dev-haskell/attoparsec-0.14:=[profile?]
	...
	>=dev-haskell/primitive-0.6.3.0:=[profile?] <dev-haskell/primitive-0.7:=[profile?]
	...
	>=dev-haskell/th-abstraction-0.2.8.0:=[profile?] <dev-haskell/th-abstraction-0.3:=[profile?]
