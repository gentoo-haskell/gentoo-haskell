...
RDEPEND="dev-haskell/attoparsec:=[profile?]
	>=dev-haskell/hnix-store-core-0.4:=[profile?] <dev-haskell/hnix-store-core-0.5:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( io-testsuite? ( dev-haskell/hspec-expectations-lifted
...
src_configure() {
	haskell-cabal_src_configure \
		$(cabal_flag io-testsuite io-testsuite)
}
