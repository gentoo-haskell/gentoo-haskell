...
SLOT="0/${PV}"
KEYWORDS="~amd64 ~x86"
IUSE="+cpu-flags-x86-rdrand +cpu_flags_x86_aes cpu_flags_x86_sse cpu_flags_x86_sse4_1 +integer-gmp +target-attributes"
...
PATCHES=( "${FILESDIR}"/${PN}-0.28-align-hack.patch
		  "${DISTDIR}"/${PN}-338.patch )
