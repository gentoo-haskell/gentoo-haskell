...
REQUIRED_USE="license-report? ( exe )"

RDEPEND="
	>=dev-haskell/aeson-2.0.0.0:=[profile?] <dev-haskell/aeson-2.2:=[profile?]
	...
	exe? (
		...
		>=dev-haskell/optparse-applicative-0.17.0.0:=[profile?] <dev-haskell/optparse-applicative-0.18:=[profile?]
	...
	license-report? (
		>=dev-haskell/cabal-install-parsers-0.6:=[profile?] <dev-haskell/cabal-install-parsers-0.7:=[profile?]
