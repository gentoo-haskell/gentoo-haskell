...
RESTRICT=test # test fails on "Arbitrary generates valid ASTs"
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/hunit-1.2 <dev-haskell/hunit-1.7
		...
		>=dev-haskell/testing-feat-0.4.0.2 )
"
...
src_prepare() {
	...
	cabal_chdeps \
		'directory >= 1.2 && < 1.4' 'directory >= 1.2' \
		'testing-feat >= 0.4.0.2 && < 1.1' 'testing-feat >= 0.4.0.2'
}
