...
RESTRICT="test" # Tests are very complex and some require internet access, among other things
...
RDEPEND="dev-haskell/aeson:=[profile?]
	...
	>=dev-haskell/hls-graph-1.5.1:=[profile?] <dev-haskell/hls-graph-1.6:=[profile?]
...
#	!bench-exe? ( test? ( dev-haskell/shake
