...
RDEPEND=">=dev-haskell/glib-0.12.5.0:${GTK_MAJ_VER}=[profile?] <dev-haskell/glib-0.13:${GTK_MAJ_VER}=[profile?]
	>=dev-haskell/gtk-0.12.5.0:${GTK_MAJ_VER}=[profile?] <dev-haskell/gtk-0.13:${GTK_MAJ_VER}=[profile?]
	>=dev-haskell/pango-0.12.5.0:${GTK_MAJ_VER}=[profile?] <dev-haskell/pango-0.13:${GTK_MAJ_VER}=[profile?]
	>=dev-lang/ghc-6.10.4:=
	x11-libs/gtkglext
"
DEPEND="${RDEPEND}
