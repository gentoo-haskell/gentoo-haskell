...
PATCHES=( "${FILESDIR}/${PN}-1.1.0.0-modify-flags.patch" )
...
RDEPEND=">=dev-haskell/ansi-terminal-0.10.3:=[profile?] <dev-haskell/ansi-terminal-0.12:=[profile?]
	...
	>=dev-haskell/optparse-applicative-0.15.1:=[profile?] <dev-haskell/optparse-applicative-0.17:=[profile?]
	...
	examples? ( >=dev-haskell/haskell-src-exts-1.23.0:=[profile?] <dev-haskell/haskell-src-exts-1.24:=[profile?] )
	executable? ( >=dev-haskell/haskell-src-exts-1.23.0:=[profile?] <dev-haskell/haskell-src-exts-1.24:=[profile?] )
"
DEPEND="${RDEPEND}
...
#		!examples? ( !executable? ( >=dev-haskell/haskell-src-exts-1.23.0 <dev-haskell/haskell-src-exts-1.24 ) ) )
