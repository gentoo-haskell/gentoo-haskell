...
RDEPEND=">=dev-haskell/bifunctors-5.6:=[profile?] <dev-haskell/bifunctors-5.7:=[profile?]
	...
	>=dev-haskell/invariant-0.5.5:=[profile?] <dev-haskell/invariant-0.7:=[profile?]
	>=dev-haskell/profunctors-5.6:=[profile?] <dev-haskell/profunctors-5.7:=[profile?]
	>=dev-haskell/scientific-0.3:=[profile?] <dev-haskell/scientific-0.4:=[profile?]
	>=dev-haskell/selective-0.7:=[profile?] <dev-haskell/selective-0.8:=[profile?]
	>=dev-haskell/semigroupoids-6:=[profile?] <dev-haskell/semigroupoids-7:=[profile?]
