...
RDEPEND=">=dev-haskell/primitive-0.7.4:=[profile?] <dev-haskell/primitive-0.10:=[profile?]
	>=dev-haskell/primitive-addr-0.1:=[profile?] <dev-haskell/primitive-addr-0.2:=[profile?]
	>=dev-haskell/primitive-unlifted-0.1.2:=[profile?] <dev-haskell/primitive-unlifted-2.2:=[profile?]
