...
RDEPEND=">=dev-haskell/async-2.2:=[profile?] <dev-haskell/async-3:=[profile?]
	...
	>=dev-haskell/th-abstraction-0.3.1.0:=[profile?] <dev-haskell/th-abstraction-0.8:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/doctest-0.16.0.1 <dev-haskell/doctest-0.24
