...
RDEPEND=">=dev-haskell/arrows-0.4:=[profile?]
	...
	>=dev-haskell/lambdabot-reference-plugins-5:=[profile?] <dev-haskell/lambdabot-reference-plugins-5.1:=[profile?]
	>=dev-haskell/lambdabot-trusted-5:=[profile?] <dev-haskell/lambdabot-trusted-5.1:=[profile?]
