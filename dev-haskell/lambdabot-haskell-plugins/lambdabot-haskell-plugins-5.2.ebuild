...
RDEPEND=">=dev-haskell/arrows-0.4:=[profile?]
	...
	>=dev-haskell/haskell-src-exts-simple-1.18.0.0:=[profile?] <dev-haskell/haskell-src-exts-simple-1.22:=[profile?]
	...
	>=dev-haskell/lambdabot-reference-plugins-5.2:=[profile?] <dev-haskell/lambdabot-reference-plugins-5.3:=[profile?]
	>=dev-haskell/lambdabot-trusted-5.2:=[profile?] <dev-haskell/lambdabot-trusted-5.3:=[profile?]
