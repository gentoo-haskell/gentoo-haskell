...
RDEPEND=">=dev-haskell/blaze-builder-0.3.3:=[profile?] <dev-haskell/blaze-builder-0.4:=[profile?]
	...
	>=dev-haskell/network-conduit-0.5:=[profile?] <dev-haskell/network-conduit-1.2:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( dev-haskell/async
		>=dev-haskell/blaze-builder-0.3.3 <dev-haskell/blaze-builder-0.4
		...
		>=dev-haskell/simple-sendfile-0.2.4 <dev-haskell/simple-sendfile-0.3
		>=dev-haskell/transformers-0.2.2 <dev-haskell/transformers-0.4
		dev-haskell/wai )
"
