...
RDEPEND=">=dev-haskell/aeson-1.1.2.0:=[profile?] <dev-haskell/aeson-1.5:=[profile?]
	>=dev-haskell/base-compat-0.10.0:=[profile?] <dev-haskell/base-compat-0.11:=[profile?]
	>=dev-haskell/cabal-2:=[profile?] <dev-haskell/cabal-2.3:=[profile?]
	...
	>=dev-haskell/lens-4.15.4:=[profile?] <dev-haskell/lens-4.17:=[profile?]
