...
RDEPEND=">=dev-haskell/aeson-0.5:=[profile?] <dev-haskell/aeson-0.7:=[profile?]
	...
	>=dev-haskell/crypto-api-0.11:=[profile?] <dev-haskell/crypto-api-0.13:=[profile?]
	...
	>=dev-haskell/http-conduit-1.9:=[profile?] <dev-haskell/http-conduit-1.10:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/hspec-1.4 <dev-haskell/hspec-1.8
		dev-haskell/hunit
