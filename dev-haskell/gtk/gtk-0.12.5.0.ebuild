...
RDEPEND=">=dev-haskell/cairo-0.12.5:${GTK_MAJ_VER}=[profile?] <dev-haskell/cairo-0.13:${GTK_MAJ_VER}=[profile?]
	>=dev-haskell/glib-0.12.5:${GTK_MAJ_VER}=[profile?] <dev-haskell/glib-0.13:${GTK_MAJ_VER}=[profile?]
	dev-haskell/mtl:=[profile?]
	>=dev-haskell/pango-0.12.5:${GTK_MAJ_VER}=[profile?] <dev-haskell/pango-0.13:${GTK_MAJ_VER}=[profile?]
	>=dev-lang/ghc-6.10.4:=
	dev-libs/glib:2
	x11-libs/gtk+:${GTK_MAJ_VER}
	gio? ( >=dev-haskell/gio-0.12.5:${GTK_MAJ_VER}=[profile?] <dev-haskell/gio-0.13:${GTK_MAJ_VER}=[profile?] )
"
DEPEND="${RDEPEND}
