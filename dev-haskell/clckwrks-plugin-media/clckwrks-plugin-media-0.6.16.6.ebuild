...
RDEPEND=">=dev-haskell/acid-state-0.12:=[profile?] <dev-haskell/acid-state-0.16:=[profile?]
	...
	>=dev-haskell/clckwrks-0.21:=[profile?] <dev-haskell/clckwrks-0.26:=[profile?]
...
src_prepare() {
	...
	cabal_chdeps \
		'clckwrks               >= 0.21 && < 0.25' 'clckwrks               >= 0.21'
}
