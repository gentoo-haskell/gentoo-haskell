...
RDEPEND=">=dev-haskell/attoparsec-0.10:=[profile?]
		...
		>=dev-haskell/http-reverse-proxy-0.1.0.4:=[profile?]
		...
		>=dev-haskell/project-template-0.1:=[profile?]
		...
		>=dev-haskell/shakespeare-js-1.0.1:=[profile?]
		<dev-haskell/shakespeare-js-1.1:=[profile?]
		...
		>=dev-haskell/yesod-default-1.1.1:=[profile?]
