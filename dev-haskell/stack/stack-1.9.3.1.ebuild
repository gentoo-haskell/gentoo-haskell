...
RDEPEND=">=dev-haskell/annotated-wl-pprint-0.7.0:=[profile?] <dev-haskell/annotated-wl-pprint-0.8:=[profile?]
	...
	>=dev-haskell/githash-0.1.3.0:=[profile?] <dev-haskell/githash-0.2:=[profile?]
	...
	>=dev-haskell/hpack-0.31.1:=[profile?] <dev-haskell/hpack-0.32:=[profile?]
	...
	>=dev-haskell/yaml-0.10.4.0:=[profile?] <dev-haskell/yaml-0.12:=[profile?]
	>=dev-haskell/zip-archive-0.3.3:=[profile?] <dev-haskell/zip-archive-0.5:=[profile?]
