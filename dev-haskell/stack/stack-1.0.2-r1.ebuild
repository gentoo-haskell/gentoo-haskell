...
RDEPEND=">=dev-haskell/aeson-0.8.0.2:=[profile?]
	...
	>=dev-haskell/errors-2.0.1:=[profile?] <dev-haskell/errors-2.2:=[profile?]
	...
	>=dev-haskell/http-client-0.4.26.2:=[profile?] <dev-haskell/http-client-0.5:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/attoparsec-0.13.0.1 <dev-haskell/attoparsec-0.14
		>=dev-haskell/conduit-extra-1.1.9.2 <dev-haskell/conduit-extra-1.2
		>=dev-haskell/hspec-2.2.1 <dev-haskell/hspec-2.3
		>=dev-haskell/http-conduit-2.1.8 <dev-haskell/http-conduit-2.2
		>=dev-haskell/monad-logger-0.3.16 <dev-haskell/monad-logger-0.4
