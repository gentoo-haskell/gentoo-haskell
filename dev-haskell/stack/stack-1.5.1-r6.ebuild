...
RDEPEND=">=dev-haskell/aeson-1.0:=[profile?] <dev-haskell/aeson-1.2:=[profile?]
	...
	>=dev-haskell/cabal-1.24:=[profile?] <dev-haskell/cabal-1.25:=[profile?]
	...
	>=dev-haskell/hpack-0.17.0:=[profile?] <dev-haskell/hpack-0.19:=[profile?]
	...
	>=dev-haskell/microlens-mtl-0.1.10.0:=[profile?] <dev-haskell/microlens-mtl-0.2:=[profile?]
	>=dev-haskell/mintty-0.1.1:=[profile?] <dev-haskell/mintty-0.2:=[profile?]
	...
	>=dev-haskell/safe-exceptions-0.1.5.0:=[profile?] <dev-haskell/safe-exceptions-0.2:=[profile?]
	...
	>=dev-haskell/store-0.4.1:=[profile?] <dev-haskell/store-0.5:=[profile?]
	...
	>=dev-haskell/unix-compat-0.4.1.4:=[profile?]
	...
	>=dev-lang/ghc-7.10.1:=
	>=dev-haskell/persistent-sqlite-2.1.4:=[profile?] <dev-haskell/persistent-sqlite-2.7:=[profile?]
"
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/attoparsec-0.13.1.0 <dev-haskell/attoparsec-0.14
		...
		>=dev-haskell/resourcet-1.1.9 <dev-haskell/resourcet-1.2
