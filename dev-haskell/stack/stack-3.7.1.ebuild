...
RDEPEND=">=dev-haskell/aeson-2.0.3.0:=[profile?]
	...
	>=dev-haskell/conduit-1.3.6.1:=[profile?]
	>=dev-haskell/conduit-extra-1.3.7:=[profile?]
	>=dev-haskell/crypton-1.0.4:=[profile?]
	...
	>=dev-haskell/generic-deriving-1.14.6:=[profile?]
	>=dev-haskell/githash-0.1.7.0:=[profile?]
	>=dev-haskell/hashable-1.4.7.0:=[profile?]
	>=dev-haskell/hi-file-parser-0.1.7.0:=[profile?]
	>=dev-haskell/hpack-0.36.0:=[profile?]
	>=dev-haskell/http-client-0.7.19:=[profile?]
	>=dev-haskell/http-client-tls-0.3.6.2:=[profile?]
	>=dev-haskell/http-conduit-2.3.9.1:=[profile?]
	...
	>=dev-haskell/unix-compat-0.7.4:=[profile?]
	>=dev-haskell/unordered-containers-0.2.20:=[profile?]
	>=dev-haskell/vector-0.13.2.0:=[profile?]
	>=dev-haskell/yaml-0.11.11.2:=[profile?]
	>=dev-haskell/zlib-0.7.1.0:=[profile?]
	>=dev-lang/ghc-9.8.4:=
"
DEPEND="${RDEPEND}
	>=dev-haskell/cabal-3.10.3.0 <dev-haskell/cabal-3.12
	test? ( >=dev-haskell/hspec-2.11.12
