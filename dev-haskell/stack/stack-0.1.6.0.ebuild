...
inherit haskell-cabal haskell-cabal
...
RDEPEND=">=dev-haskell/aeson-0.8.0.2:=[profile?] <dev-haskell/aeson-0.10:=[profile?]
	...
	>=dev-haskell/bifunctors-4.2.1:=[profile?] <dev-haskell/bifunctors-5.1:=[profile?]
