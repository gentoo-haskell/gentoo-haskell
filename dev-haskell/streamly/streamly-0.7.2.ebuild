...
SLOT="0/${PV}"
KEYWORDS="~amd64 ~x86"
IUSE="debug dev examples examples-sdl fusion-plugin no-fusion streamk"
...
PATCHES="${FILESDIR}/${PN}-0.7.2-upstream-duplicate-instance-fix.patch"
