...
# We'll use git until upstream adds the `misc` directory to the release tarball,
# which is needed in order to execute the test suite
inherit haskell-cabal git-r3

DESCRIPTION="Haskell API Search"
HOMEPAGE="https://hoogle.haskell.org/"
EGIT_REPO_URI="https://github.com/ndmitchell/hoogle"
EGIT_COMMIT="v${PV}"
