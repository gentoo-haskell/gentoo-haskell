...
RDEPEND=">=dev-haskell/acid-state-0.6:=[profile?] <dev-haskell/acid-state-0.15:=[profile?]
	...
	>=dev-haskell/email-validate-2.1:=[profile?] <dev-haskell/email-validate-2.3:=[profile?]
	...
	>=dev-haskell/happstack-server-6.0:=[profile?] <dev-haskell/happstack-server-7.5:=[profile?]
	...
	>=dev-haskell/http-conduit-1.4:=[profile?] <dev-haskell/http-conduit-2.3:=[profile?]
	>=dev-haskell/http-types-0.6:=[profile?] <dev-haskell/http-types-0.10:=[profile?]
	...
	>=dev-haskell/lens-4.2:=[profile?] <dev-haskell/lens-4.16:=[profile?]
	...
	>=dev-lang/ghc-7.4.1:=
	>=dev-haskell/aeson-0.11:=[profile?] <dev-haskell/aeson-1.2:=[profile?]
"
DEPEND="${RDEPEND}
