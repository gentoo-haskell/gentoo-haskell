...
RDEPEND=">=dev-haskell/acid-state-0.6:=[profile?] <dev-haskell/acid-state-0.16:=[profile?]
	...
	>=dev-haskell/lens-4.2:=[profile?] <dev-haskell/lens-4.18:=[profile?]
	...
	>=dev-lang/ghc-7.4.1:=
	>=dev-haskell/aeson-0.11:=[profile?] <dev-haskell/aeson-1.5:=[profile?]
"
DEPEND="${RDEPEND}
