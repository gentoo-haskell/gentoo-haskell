...
RDEPEND="dev-haskell/cabal:=[profile?]
	...
	>=dev-haskell/ghc-typelits-extra-0.3.2:=[profile?] <dev-haskell/ghc-typelits-extra-0.6:=[profile?]
	>=dev-haskell/ghc-typelits-knownnat-0.6:=[profile?] <dev-haskell/ghc-typelits-knownnat-0.9:=[profile?]
	>=dev-haskell/ghc-typelits-natnormalise-0.6:=[profile?] <dev-haskell/ghc-typelits-natnormalise-0.10:=[profile?]
