...
RESTRICT="test" # Tests seem to require a working nix setup
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-0.14.0.8-hashable-1_4-fix.patch"
)

RDEPEND=">=dev-haskell/aeson-1.4.2:=[profile?] <dev-haskell/aeson-2.1:=[profile?]
