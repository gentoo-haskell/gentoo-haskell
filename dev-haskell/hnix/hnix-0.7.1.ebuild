...
KEYWORDS="~amd64 ~x86"
IUSE=""
RESTRICT="test" # 27 out of 265 tests fail
RDEPEND=">=dev-haskell/aeson-1.4.2:=[profile?] <dev-haskell/aeson-1.5:=[profile?]
	...
	>=dev-haskell/these-1.0.1:=[profile?] <dev-haskell/these-1.1:=[profile?]
	...
	>=dev-lang/ghc-8.4.3:=
	>=dev-haskell/dependent-sum-0.4:=[profile?] <dev-haskell/dependent-sum-0.7:=[profile?]
...
PATCHES=( "${FILESDIR}/${P}-repline-ambiguity.patch" )
