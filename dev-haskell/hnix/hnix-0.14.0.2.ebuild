...
# Tests try to do system-level things
# Exception: nix-instantiate: readCreateProcess: posix_spawnp: does not exist (No such file or directory)
RESTRICT="test"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-0.14.0.2-fix-imports.patch"
)
...
RDEPEND=">=dev-haskell/aeson-1.4.2:=[profile?] <dev-haskell/aeson-1.6:=[profile?]
	...
	>=dev-haskell/logict-0.7.0.2:=[profile?] <dev-haskell/logict-0.8:=[profile?]
	...
	>=dev-haskell/relude-1.0.0:=[profile?] <dev-haskell/relude-1.1.0:=[profile?]
	...
	>=dev-lang/ghc-8.6.3:=
	executable? ( >=dev-haskell/haskeline-0.8.0.0:=[profile?] <dev-haskell/haskeline-0.9:=[profile?]
