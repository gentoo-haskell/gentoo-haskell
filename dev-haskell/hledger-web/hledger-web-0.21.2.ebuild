...
RDEPEND="dev-haskell/clientsession:=[profile?]
		...
		~dev-haskell/hledger-0.21.2:=[profile?]
		~dev-haskell/hledger-lib-0.21.2:=[profile?]
		...
		>=dev-haskell/yesod-platform-1.2.0.1:=[profile?]
		<dev-haskell/yesod-platform-1.3:=[profile?]
		dev-haskell/yesod-static:=[profile?]
		>=dev-lang/ghc-6.12.1:=
		blaze_html_0_4? ( =dev-haskell/blaze-html-0.4*:=[profile?]
		)
		!blaze_html_0_4? ( <dev-haskell/blaze-html-0.7:=[profile?]
