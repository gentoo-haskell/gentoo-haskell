...
RDEPEND=">=dev-haskell/blaze-html-0.5:=[profile?] <dev-haskell/blaze-html-0.8:=[profile?]
	...
	>=dev-haskell/http-client-0.2:=[profile?] <dev-haskell/http-client-0.4:=[profile?]
	...
	>=dev-haskell/warp-1.3:=[profile?] <dev-haskell/warp-2.2:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( dev-haskell/hspec
		>=dev-haskell/yesod-1.2 <dev-haskell/yesod-1.3
