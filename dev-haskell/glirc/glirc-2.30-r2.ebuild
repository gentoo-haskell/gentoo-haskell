...
RDEPEND=">=dev-haskell/async-2.1:=[profile?] <dev-haskell/async-2.3:=[profile?]
	...
	>=dev-haskell/hookup-0.2.2:=[profile?] <dev-haskell/hookup-0.3:=[profile?]
	>=dev-haskell/hsopenssl-0.11:=[profile?] <dev-haskell/hsopenssl-0.12:=[profile?]
	>=dev-haskell/irc-core-2.6:=[profile?]
...
src_prepare() {
	...
	cabal_chdeps \
		...
		'irc-core             >=2.6    && <2.7' 'irc-core             >=2.6' \
		'vty                  >=5.23.1 && <5.26' 'vty                  >=5.23.1'
}
