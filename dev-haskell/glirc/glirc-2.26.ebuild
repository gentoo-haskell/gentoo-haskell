...
RDEPEND=">=dev-haskell/async-2.1:=[profile?] <dev-haskell/async-2.3:=[profile?]
	...
	>=dev-haskell/irc-core-2.3:=[profile?] <dev-haskell/irc-core-2.4:=[profile?]
	>=dev-haskell/kan-extensions-5.0:=[profile?] <dev-haskell/kan-extensions-5.2:=[profile?]
...
"
DEPEND="${RDEPEND}
	>=dev-haskell/cabal-1.24.0.0 <dev-haskell/cabal-2.3
