...
RDEPEND=">=dev-haskell/async-2.1:=[profile?] <dev-haskell/async-2.3:=[profile?]
	...
	>=dev-haskell/config-schema-0.4:=[profile?] <dev-haskell/config-schema-0.6:=[profile?]
	>=dev-haskell/config-value-0.6:=[profile?] <dev-haskell/config-value-0.7:=[profile?]
	...
	>=dev-haskell/hookup-0.2:=[profile?] <dev-haskell/hookup-0.3:=[profile?]
	>=dev-haskell/hsopenssl-0.11:=[profile?] <dev-haskell/hsopenssl-0.12:=[profile?]
	>=dev-haskell/irc-core-2.5:=[profile?] <dev-haskell/irc-core-2.6:=[profile?]
	>=dev-haskell/kan-extensions-5.0:=[profile?] <dev-haskell/kan-extensions-5.3:=[profile?]
	>=dev-haskell/lens-4.14:=[profile?]
	>=dev-haskell/network-2.6.2:=[profile?] <dev-haskell/network-2.9:=[profile?]
	...
	>=dev-haskell/vty-5.23.1:=[profile?] <dev-haskell/vty-5.25:=[profile?]
	>=dev-lang/ghc-8.0.1:=
"
DEPEND="${RDEPEND}
