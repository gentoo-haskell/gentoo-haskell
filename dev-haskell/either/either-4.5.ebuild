...
RDEPEND=">=dev-haskell/bifunctors-4:=[profile?] <dev-haskell/bifunctors-6:=[profile?]
	...
	>=dev-haskell/free-4.9:=[profile?]
	>=dev-haskell/mmorph-1.0.0:=[profile?] <dev-haskell/mmorph-1.2:=[profile?]
	>=dev-haskell/monad-control-0.3.2:=[profile?] <dev-haskell/monad-control-1.1:=[profile?]
	>=dev-haskell/monadrandom-0.1:=[profile?] <dev-haskell/monadrandom-0.6:=[profile?]
...
src_prepare() {
	...
	cabal_chdeps \
		'exceptions        >= 0.5     && < 0.9' 'exceptions        >= 0.5' \
		'free              >= 4.9     && < 5' 'free              >= 4.9'
}
