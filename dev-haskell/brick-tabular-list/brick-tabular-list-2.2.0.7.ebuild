...
RDEPEND=">=dev-haskell/brick-1.5:=[profile?] <dev-haskell/brick-2.2:=[profile?]
	...
	>=dev-haskell/vty-5.38:=[profile?] <dev-haskell/vty-6.2:=[profile?]
	>=dev-lang/ghc-9.2.4:=
	demo? ( >=dev-haskell/vector-0.12.3.1:=[profile?] <dev-haskell/vector-0.14:=[profile?] )
"
DEPEND="${RDEPEND}
