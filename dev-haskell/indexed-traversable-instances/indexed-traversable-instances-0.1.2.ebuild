...
RDEPEND=">=dev-haskell/indexed-traversable-0.1.4:=[profile?] <dev-haskell/indexed-traversable-0.2:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/quickcheck-2.14.2 <dev-haskell/quickcheck-2.16
		...
		>=dev-haskell/tasty-quickcheck-0.10.1.1 <dev-haskell/tasty-quickcheck-0.12 )
"
