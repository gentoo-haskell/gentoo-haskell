...
RDEPEND=">=dev-haskell/aeson-1.0.0.0:=[profile?] <dev-haskell/aeson-1.6:=[profile?]
	...
	>=dev-haskell/repline-0.2.1.0:=[profile?] <dev-haskell/repline-0.4:=[profile?]
	...
	>=dev-haskell/text-manipulate-0.2.0.1:=[profile?] <dev-haskell/text-manipulate-0.3:=[profile?]
	...
	>=dev-lang/ghc-8.0.2:=
	http? ( >=dev-haskell/http-client-0.4.30:=[profile?] <dev-haskell/http-client-0.8:=[profile?]
