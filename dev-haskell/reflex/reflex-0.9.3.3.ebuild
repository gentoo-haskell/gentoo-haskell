...
CABAL_CHDEPS=(
	...
	'constraints >= 0.10 && <0.15' 'constraints >= 0.10'
	'primitive >= 0.5 && < 0.10' 'primitive >= 0.5'
	'lens >= 4.7 && < 5.4' 'lens >= 4.7'
)

RDEPEND="
	>=dev-haskell/bifunctors-5.2:=[profile?] <dev-haskell/bifunctors-5.7:=[profile?]
	>=dev-haskell/commutative-semigroups-0.1:=[profile?] <dev-haskell/commutative-semigroups-0.3:=[profile?]
	...
	>=dev-haskell/lens-4.7:=[profile?] <dev-haskell/lens-5.4:=[profile?]
	...
	>=dev-haskell/monoidal-containers-0.6.2.0:=[profile?] <dev-haskell/monoidal-containers-0.7:=[profile?]
	...
	>=dev-haskell/semigroupoids-4.0:=[profile?] <dev-haskell/semigroupoids-7:=[profile?]
