...
EGIT_REPO_URI="https://github.com/reflex-frp/reflex"
...
RDEPEND=">=dev-haskell/bifunctors-5.2:=[profile?] <dev-haskell/bifunctors-5.6:=[profile?]
	...
	>=dev-haskell/monoidal-containers-0.3.0.2:=[profile?] <dev-haskell/monoidal-containers-0.4:=[profile?]
...
src_configure() {
	haskell-cabal_src_configure \
		$(cabal_flag debug-trace-events) \
		$(cabal_flag fast-weak) \
