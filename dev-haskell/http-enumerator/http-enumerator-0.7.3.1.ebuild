...
RDEPEND=">=dev-haskell/asn1-data-0.5.1[profile?] <dev-haskell/asn1-data-0.7[profile?]
		>=dev-haskell/attoparsec-0.8.0.2[profile?] <dev-haskell/attoparsec-0.11[profile?]
		>=dev-haskell/attoparsec-enumerator-0.2.0.4[profile?] <dev-haskell/attoparsec-enumerator-0.4[profile?]
		...
		>=dev-haskell/enumerator-0.4.9[profile?] <dev-haskell/enumerator-0.5[profile?]
		...
		>=dev-haskell/tls-extra-0.4.3[profile?] <dev-haskell/tls-extra-0.5[profile?]
