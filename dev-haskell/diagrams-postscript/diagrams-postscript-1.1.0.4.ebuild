...
RDEPEND="<dev-haskell/data-default-class-0.1:=[profile?]
	>=dev-haskell/diagrams-core-1.0:=[profile?] <dev-haskell/diagrams-core-1.3:=[profile?]
	...
	>=dev-haskell/vector-space-0.7.7:=[profile?] <dev-haskell/vector-space-0.10:=[profile?]
	>=dev-lang/ghc-7.4.1:=
"
DEPEND="${RDEPEND}
