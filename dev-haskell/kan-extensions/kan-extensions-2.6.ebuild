...
RDEPEND=">=dev-haskell/adjunctions-2.4.0.1[profile?]
		<dev-haskell/adjunctions-2.5[profile?]
		>=dev-haskell/comonad-1.1.1.5[profile?]
		...
		>=dev-haskell/representable-functors-2.4.0.1[profile?]
		<dev-haskell/representable-functors-2.5[profile?]
