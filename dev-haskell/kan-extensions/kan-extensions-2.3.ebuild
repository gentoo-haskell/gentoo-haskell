...
RDEPEND=">=dev-haskell/adjunctions-2.2.1.1[profile?]
		<dev-haskell/adjunctions-2.3[profile?]
		...
		>=dev-haskell/representable-functors-2.2.1.1[profile?]
		<dev-haskell/representable-functors-2.3[profile?]
