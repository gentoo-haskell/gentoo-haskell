...
RDEPEND=">=dev-haskell/aeson-0.7:=[profile?]
	...
	>=dev-haskell/hoodle-builder-0.4:=[profile?]
	>=dev-haskell/hoodle-parser-0.4:=[profile?]
	>=dev-haskell/hoodle-publish-0.2.1:=[profile?]
	...
	hub? ( dev-haskell/case-insensitive:=[profile?]
		>=dev-haskell/dbus-0.10:=[profile?]
