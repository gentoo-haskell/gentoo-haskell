...
CABAL_FEATURES="lib profile haddock hoogle hscolour" # Disable test-suite: circular dependency
...
RESTRICT=test # circular dependency: hspec-core[test]->temporary->tasty->async->test-framework->base-orphans->hspec->hspec-core
...
RDEPEND=">=dev-haskell/ansi-terminal-0.5:=[profile?]
	...
	>=dev-haskell/quickcheck-2.12:2=[profile?] <dev-haskell/quickcheck-2.13:2=[profile?]
