...
RDEPEND=">=dev-haskell/hslua-aeson-2.2:=[profile?] <dev-haskell/hslua-aeson-2.3:=[profile?]
	...
	>=dev-haskell/hslua-core-2.2.1:=[profile?] <dev-haskell/hslua-core-2.3:=[profile?]
	>=dev-haskell/hslua-marshalling-2.2.1:=[profile?] <dev-haskell/hslua-marshalling-2.3:=[profile?]
	>=dev-haskell/hslua-objectorientation-2.2.1:=[profile?] <dev-haskell/hslua-objectorientation-2.3:=[profile?]
	>=dev-haskell/hslua-packaging-2.2.1:=[profile?] <dev-haskell/hslua-packaging-2.3:=[profile?]
	>=dev-lang/ghc-8.10.1:=
"
DEPEND="${RDEPEND}
