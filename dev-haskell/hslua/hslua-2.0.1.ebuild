...
RDEPEND=">=dev-haskell/exceptions-0.8:=[profile?] <dev-haskell/exceptions-0.11:=[profile?]
	>=dev-haskell/hslua-classes-2.0:=[profile?] <dev-haskell/hslua-classes-2.1:=[profile?]
	>=dev-haskell/hslua-core-2.0.0.2:=[profile?] <dev-haskell/hslua-core-2.1:=[profile?]
	>=dev-haskell/hslua-marshalling-2.0.1:=[profile?] <dev-haskell/hslua-marshalling-2.1:=[profile?]
	>=dev-haskell/hslua-objectorientation-2.0.1:=[profile?] <dev-haskell/hslua-objectorientation-2.1:=[profile?]
