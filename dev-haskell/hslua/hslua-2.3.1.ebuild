...
RDEPEND=">=dev-haskell/hslua-aeson-2.3.1:=[profile?] <dev-haskell/hslua-aeson-2.4:=[profile?]
	...
	>=dev-haskell/hslua-objectorientation-2.3.1:=[profile?] <dev-haskell/hslua-objectorientation-2.4:=[profile?]
	>=dev-haskell/hslua-packaging-2.3.1:=[profile?] <dev-haskell/hslua-packaging-2.4:=[profile?]
	>=dev-haskell/hslua-typing-0.1.1:=[profile?] <dev-haskell/hslua-typing-0.2:=[profile?]
