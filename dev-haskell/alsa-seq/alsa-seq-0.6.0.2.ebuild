...
RDEPEND="=dev-haskell/alsa-core-0.5*:=[profile?]
		>=dev-haskell/data-accessor-0.2.2:=[profile?]
		<dev-haskell/data-accessor-0.3:=[profile?]
		>=dev-haskell/enumset-0.0.3:=[profile?]
		<dev-haskell/enumset-0.1:=[profile?]
		>=dev-haskell/extensible-exceptions-0.1.1:=[profile?]
		<dev-haskell/extensible-exceptions-0.2:=[profile?]
		=dev-haskell/poll-0.0*:=[profile?]
		>=dev-haskell/transformers-0.2:=[profile?]
		<dev-haskell/transformers-0.4:=[profile?]
		>=dev-haskell/utility-ht-0.0.7:=[profile?]
