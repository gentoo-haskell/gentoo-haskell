...
RDEPEND=">=dev-haskell/aeson-0.5:=[profile?]
	...
	>=dev-haskell/persistent-2.0.1:=[profile?] <dev-haskell/persistent-2.1:=[profile?]
	>=dev-haskell/postgresql-libpq-0.6.1:=[profile?] <dev-haskell/postgresql-libpq-0.10:=[profile?]
	>=dev-haskell/postgresql-simple-0.3.10:=[profile?] <dev-haskell/postgresql-simple-0.5:=[profile?]
