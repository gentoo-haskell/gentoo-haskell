...
RDEPEND=">=dev-haskell/ansi-terminal-0.6.2.3:=
	...
	>=dev-haskell/hledger-1.17.1.1:= <dev-haskell/hledger-1.18:=
	>=dev-haskell/hledger-lib-1.17.1:= <dev-haskell/hledger-lib-1.18:=
	>=dev-haskell/megaparsec-7.0.0:= <dev-haskell/megaparsec-8.1:=
