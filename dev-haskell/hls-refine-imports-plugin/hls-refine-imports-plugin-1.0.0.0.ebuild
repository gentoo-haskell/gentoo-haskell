...
RESTRICT="test" # Required files are not included in tarball
...
RDEPEND="dev-haskell/aeson:=[profile?]
	...
	>=dev-haskell/hls-explicit-imports-plugin-1.0.0.1:=[profile?] <dev-haskell/hls-explicit-imports-plugin-1.1:=[profile?]
