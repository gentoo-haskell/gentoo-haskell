...
#hackport: flags: doctests:test,unittests:test,-large-tuples,-multiple-hidden,-strict-mapsignal,-super-strict,-benchmarks
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/doctest-parallel-0.2 <dev-haskell/doctest-parallel-0.3
