...
SLOT="0/${PV}"
KEYWORDS="~amd64"
IUSE="+test workaround-ghc-mmap-crash"

CABAL_CHDEPS=(
	'ghc-prim                  >= 0.5.1.0 && < 0.13' 'ghc-prim >= 0.5.1.0'
	'template-haskell          >= 2.12.0.0 && < 2.23' 'template-haskell >= 2.12.0.0'
	'hedgehog      >= 1.0.3    && < 1.6' 'hedgehog >= 1.0.3'
)
...
RDEPEND=">=dev-haskell/arrows-0.4:=[profile?] <dev-haskell/arrows-0.5:=[profile?]
	...
	>=dev-haskell/ghc-typelits-extra-0.4:=[profile?] <dev-haskell/ghc-typelits-extra-0.6:=[profile?]
	>=dev-haskell/ghc-typelits-knownnat-0.7.2:=[profile?] <dev-haskell/ghc-typelits-knownnat-0.9:=[profile?]
	>=dev-haskell/ghc-typelits-natnormalise-0.7.2:=[profile?] <dev-haskell/ghc-typelits-natnormalise-0.10:=[profile?]
	...
	>=dev-haskell/quickcheck-2.7:=[profile?] <dev-haskell/quickcheck-2.16:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( test? ( >=dev-haskell/hedgehog-1.0.3
