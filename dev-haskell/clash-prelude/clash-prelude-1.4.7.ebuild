...
#hackport: flags: doctests:test,unittests:test,-large-tuples,-multiple-hidden,-strict-mapsignal,-super-strict
...
RDEPEND=">=dev-haskell/arrows-0.4:=[profile?] <dev-haskell/arrows-0.5:=[profile?]
	>=dev-haskell/bifunctors-5.4.0:=[profile?] <dev-haskell/bifunctors-6.0:=[profile?]
	...
	>=dev-haskell/lens-4.10:=[profile?] <dev-haskell/lens-5.1.0:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/doctest-0.9.1 <dev-haskell/doctest-0.19
				>=dev-haskell/hedgehog-1.0.3 <dev-haskell/hedgehog-1.1
