...
RDEPEND="dev-haskell/binary[profile?]
		...
		>=dev-lang/ghc-6.10.1
		|| ( >=dev-haskell/unordered-containers-0.1.4.3[profile?] <dev-haskell/unordered-containers-0.2[profile?] >=dev-haskell/unordered-containers-0.2.1[profile?] <dev-haskell/unordered-containers-0.3[profile?] )"
DEPEND="${RDEPEND}
