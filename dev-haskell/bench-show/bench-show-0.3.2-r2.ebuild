...
RDEPEND=">=dev-haskell/csv-0.1:=[profile?] <dev-haskell/csv-0.2:=[profile?]
	...
	>=dev-haskell/optparse-applicative-0.14.2:=[profile?] <dev-haskell/optparse-applicative-0.19:=[profile?]
	...
	colors? ( >=dev-haskell/ansi-wl-pprint-0.6:=[profile?] <dev-haskell/ansi-wl-pprint-1.1:=[profile?] )
"
DEPEND="${RDEPEND}
	>=dev-haskell/cabal-3.4.1.0
	test? ( charts? ( >=dev-haskell/text-1.1.1 <dev-haskell/text-2.2 ) )
"
