...
RDEPEND=">=app-text/pandoc-1.12.4:=[profile?] <app-text/pandoc-1.13:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=app-text/pandoc-1.12.4 <app-text/pandoc-1.13
		...
		checkexternal? ( >=dev-haskell/http-conduit-2.1 <dev-haskell/http-conduit-2.2
					>=dev-haskell/http-types-0.7 <dev-haskell/http-types-0.9 ) )
	previewserver? ( test? ( >=dev-haskell/fsnotify-0.0.6 <dev-haskell/fsnotify-0.1
	...
	!previewserver? ( test? ( watchserver? ( >=dev-haskell/fsnotify-0.0.6 <dev-haskell/fsnotify-0.1
							>=dev-haskell/system-filepath-0.4.6 <=dev-haskell/system-filepath-0.5 ) ) )
"
