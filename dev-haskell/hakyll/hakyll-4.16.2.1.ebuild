...
RDEPEND=">=dev-haskell/blaze-html-0.5:=[profile?] <dev-haskell/blaze-html-0.10:=[profile?]
	...
	buildwebsite? ( || ( ( >=dev-haskell/pandoc-2.11:=[profile?] <dev-haskell/pandoc-2.20:=[profile?] )
				( >=dev-haskell/pandoc-3.0:=[profile?] <dev-haskell/pandoc-3.3:=[profile?] ) ) )
	...
	usepandoc? ( || ( ( >=dev-haskell/pandoc-2.11:=[profile?] <dev-haskell/pandoc-2.20:=[profile?] )
				( >=dev-haskell/pandoc-3.0:=[profile?] <dev-haskell/pandoc-3.3:=[profile?] ) ) )
"
DEPEND="${RDEPEND}
