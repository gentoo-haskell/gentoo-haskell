...
SLOT="0/${PV}"
KEYWORDS="~amd64 ~x86"
IUSE="buildwebsite +checkexternal +previewserver +watchserver"

RDEPEND=">=app-text/pandoc-2.0.5:=[profile?] <app-text/pandoc-2.2:=[profile?]
	...
	>=dev-haskell/file-embed-0.0.10.1:=[profile?] <dev-haskell/file-embed-0.0.11:=[profile?]
	...
	>=dev-haskell/pandoc-citeproc-0.13:=[profile?] <dev-haskell/pandoc-citeproc-0.14:=[profile?]
	...
	previewserver? ( >=dev-haskell/fsnotify-0.2:=[profile?] <dev-haskell/fsnotify-0.3:=[profile?]
				>=dev-haskell/http-types-0.9:=[profile?] <dev-haskell/http-types-0.12:=[profile?]
	...
	!previewserver? ( checkexternal? ( >=dev-haskell/http-types-0.7:=[profile?] <dev-haskell/http-types-0.12:=[profile?] )
