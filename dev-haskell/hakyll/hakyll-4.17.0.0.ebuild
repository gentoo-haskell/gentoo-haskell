...
PATCHES=(
	...
	"${FILESDIR}/${PN}-4.17.0.0-pandoc-3.10.patch"
)
...
RDEPEND=">=dev-haskell/blaze-html-0.5:=[profile?] <dev-haskell/blaze-html-0.10:=[profile?]
	...
	>=dev-haskell/wai-app-static-3.1:=[profile?] <dev-haskell/wai-app-static-3.3:=[profile?]
	>=dev-haskell/xml-conduit-1.0:=[profile?] <dev-haskell/xml-conduit-1.11:=[profile?]
	...
	buildwebsite? ( >=dev-haskell/pandoc-types-1.22:=[profile?] <dev-haskell/pandoc-types-1.24:=[profile?]
			>=dev-haskell/pandoc-2.11:=[profile?] <dev-haskell/pandoc-3.11:=[profile?] )
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/quickcheck-2.8 <dev-haskell/quickcheck-2.19
