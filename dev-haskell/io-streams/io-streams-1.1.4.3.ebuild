...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/attoparsec-0.10 <dev-haskell/attoparsec-0.12
		>=dev-haskell/blaze-builder-0.3.1 <dev-haskell/blaze-builder-0.4
		...
		>=dev-haskell/primitive-0.2 <dev-haskell/primitive-0.6
