...
RDEPEND=">=dev-haskell/cpphs-1.11[profile?] <dev-haskell/cpphs-1.14[profile?]
		>=dev-haskell/haskell-src-exts-1.11[profile?]
		<dev-haskell/haskell-src-exts-1.14[profile?]
		>=dev-haskell/hscolour-1.17[profile?] <dev-haskell/hscolour-1.20[profile?]
		>=dev-haskell/transformers-0.0[profile?] <dev-haskell/transformers-0.4[profile?]
