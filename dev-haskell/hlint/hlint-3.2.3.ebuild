...
COMMIT="6c6593e0ec0fe45640879946a181f706c2a38972"
CABAL_FEATURES="lib profile haddock hoogle hscolour"
inherit haskell-cabal elisp-common

DESCRIPTION="Source code suggestions"
HOMEPAGE="https://github.com/ndmitchell/hlint#readme"
SRC_URI=" https://github.com/ndmitchell/hlint/archive/${COMMIT}.tar.gz -> ${P}.tar.gz"

LICENSE="BSD"
SLOT="0/${PV}"
KEYWORDS="~amd64 ~x86"
IUSE="emacs +gpl hsyaml +threaded test"
RESTRICT="!test? ( test )"
...
RDEPEND=">=dev-haskell/aeson-1.1.2.0:=[profile?]
	...
	>=dev-haskell/ghc-lib-parser-ex-8.10.0.16:=[profile?] <dev-haskell/ghc-lib-parser-ex-8.10.1:=[profile?]
