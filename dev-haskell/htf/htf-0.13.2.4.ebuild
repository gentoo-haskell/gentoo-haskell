...
CABAL_FEATURES="lib profile haddock hoogle hscolour" # Broken test-suite: `local-htfpp' failed in phase `Haskell pre-processor'. (Exit code: 1)
...
RESTRICT=test # htfpp: tests/TestHTF.hs: hGetContents: invalid argument (invalid byte sequence)
