...
RDEPEND=">=dev-haskell/attoparsec-0.8.5.3:=[profile?]
	>=dev-haskell/blaze-builder-0.3.0.0:=[profile?] <dev-haskell/blaze-builder-0.4:=[profile?]
	>=dev-haskell/groundhog-0.5.0:=[profile?] <dev-haskell/groundhog-0.6.0:=[profile?]
