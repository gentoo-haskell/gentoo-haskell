...
RDEPEND="
	...
	>=dev-haskell/cabal-3.12.1.0:=[profile?] <dev-haskell/cabal-3.13:=[profile?]
	>=dev-haskell/cabal-install-solver-3.12.1.0:=[profile?] <dev-haskell/cabal-install-solver-3.13:=[profile?]
	...
	>=dev-haskell/hackage-security-0.6.2.6:=[profile?] <dev-haskell/hackage-security-0.7:=[profile?]
	>=dev-haskell/hashable-1.0:=[profile?] <dev-haskell/hashable-1.6:=[profile?]
