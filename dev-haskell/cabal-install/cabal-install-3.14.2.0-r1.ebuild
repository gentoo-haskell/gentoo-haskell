...
RESTRICT="test" #require network access
...
RDEPEND=">=dev-haskell/async-2.0:=[profile?] <dev-haskell/async-2.3:=[profile?]
	...
	>=dev-haskell/cabal-3.14.2:=[profile?] <dev-haskell/cabal-3.15:=[profile?]
	>=dev-haskell/cabal-install-solver-3.14:=[profile?] <dev-haskell/cabal-install-solver-3.15:=[profile?]
	>=dev-haskell/cabal-syntax-3.14:=[profile?] <dev-haskell/cabal-syntax-3.15:=[profile?]
	...
	>=dev-haskell/http-4000.1.5:=[profile?] <dev-haskell/http-4000.6:=[profile?]
	>=dev-haskell/network-uri-2.6.2.0:=[profile?] <dev-haskell/network-uri-2.7:=[profile?]
	...
	>=dev-haskell/tar-0.5.0.3:=[profile?] <dev-haskell/tar-0.8:=[profile?]
