...
RDEPEND=">=dev-haskell/async-2.0:= <dev-haskell/async-2.3:=
	...
	>=dev-haskell/cabal-3.8:= <dev-haskell/cabal-3.9:=
	>=dev-haskell/cabal-install-solver-3.8:= <dev-haskell/cabal-install-solver-3.9:=
	>=dev-haskell/cabal-syntax-3.8:= <dev-haskell/cabal-syntax-3.9:=
	...
	>=dev-haskell/hackage-security-0.6.2.0:= <dev-haskell/hackage-security-0.7:=
	...
	>=dev-haskell/safe-exceptions-0.1.7.0:= <dev-haskell/safe-exceptions-0.2:=
...
src_prepare() {
	...
	cabal_chdeps \
		'build-depends: base >=4.10 && <4.17' 'build-depends: base >=4.10' \
		'text       >= 1.2.3    && < 1.3' 'text       >= 1.2.3' \
		'time       >= 1.5.0.1  && < 1.12' 'time       >= 1.5.0.1'
}
