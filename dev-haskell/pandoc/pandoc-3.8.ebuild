...
RDEPEND=">=dev-haskell/aeson-2.0.1.0:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	...
	>=dev-haskell/citeproc-0.10:=[profile?] <dev-haskell/citeproc-0.11:=[profile?]
	...
	>=dev-haskell/texmath-0.13:=[profile?] <dev-haskell/texmath-0.14:=[profile?]
	...
	>=dev-haskell/typst-0.8.0.2:=[profile?] <dev-haskell/typst-0.9:=[profile?]
	>=dev-haskell/unicode-collation-0.1.1:=[profile?] <dev-haskell/unicode-collation-0.2:=[profile?]
	>=dev-haskell/unicode-data-0.6:=[profile?] <dev-haskell/unicode-data-0.7:=[profile?]
