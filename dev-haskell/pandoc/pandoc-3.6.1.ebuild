...
RDEPEND=">=dev-haskell/aeson-2.0.1.0:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	...
	>=dev-haskell/citeproc-0.8.1.2:=[profile?] <dev-haskell/citeproc-0.9:=[profile?]
	>=dev-haskell/commonmark-0.2.6.1:=[profile?] <dev-haskell/commonmark-0.3:=[profile?]
	>=dev-haskell/commonmark-extensions-0.2.5.6:=[profile?] <dev-haskell/commonmark-extensions-0.3:=[profile?]
	>=dev-haskell/commonmark-pandoc-0.2.2.3:=[profile?] <dev-haskell/commonmark-pandoc-0.3:=[profile?]
	...
	>=dev-haskell/djot-0.1.2.2:=[profile?] <dev-haskell/djot-0.2:=[profile?]
	...
	>=dev-haskell/skylighting-0.14.5:=[profile?] <dev-haskell/skylighting-0.15:=[profile?]
	>=dev-haskell/skylighting-core-0.14.5:=[profile?] <dev-haskell/skylighting-core-0.15:=[profile?]
	...
	>=dev-haskell/texmath-0.12.8.12:=[profile?] <dev-haskell/texmath-0.13:=[profile?]
	...
	>=dev-haskell/typst-0.6.1:=[profile?] <dev-haskell/typst-0.6.2:=[profile?]
