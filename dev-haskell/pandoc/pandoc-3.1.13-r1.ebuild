...
RDEPEND=">=dev-haskell/aeson-2.0.1.0:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	...
	>=dev-haskell/skylighting-0.14.1.1:=[profile?] <dev-haskell/skylighting-0.15:=[profile?]
	>=dev-haskell/skylighting-core-0.14.1.1:=[profile?] <dev-haskell/skylighting-core-0.15:=[profile?]
	...
	>=dev-haskell/texmath-0.12.8.8:=[profile?] <dev-haskell/texmath-0.13:=[profile?]
	...
	>=dev-haskell/typst-0.5.0.3:=[profile?] <dev-haskell/typst-0.5.1:=[profile?]
