...
RDEPEND=">=dev-haskell/aeson-2.0.1.0:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	...
	>=dev-haskell/citeproc-0.8.1.1:=[profile?] <dev-haskell/citeproc-0.9:=[profile?]
	...
	>=dev-haskell/djot-0.1.2.1:=[profile?] <dev-haskell/djot-0.2:=[profile?]
	...
	>=dev-haskell/skylighting-0.14.2:=[profile?] <dev-haskell/skylighting-0.15:=[profile?]
	>=dev-haskell/skylighting-core-0.14.2:=[profile?] <dev-haskell/skylighting-core-0.15:=[profile?]
	...
	>=dev-haskell/texmath-0.12.8.9:=[profile?] <dev-haskell/texmath-0.13:=[profile?]
	...
	>=dev-haskell/tls-2.0.1:=[profile?] <dev-haskell/tls-2.1:=[profile?]
	>=dev-haskell/typst-0.5.0.4:=[profile?] <dev-haskell/typst-0.5.1:=[profile?]
