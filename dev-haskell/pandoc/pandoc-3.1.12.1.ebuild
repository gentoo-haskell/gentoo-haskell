...
RDEPEND=">=dev-haskell/aeson-2.0.1.0:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	...
	>=dev-haskell/commonmark-0.2.5.1:=[profile?] <dev-haskell/commonmark-0.3:=[profile?]
	>=dev-haskell/commonmark-extensions-0.2.5.3:=[profile?] <dev-haskell/commonmark-extensions-0.3:=[profile?]
	...
	>=dev-haskell/djot-0.1.1.0:=[profile?] <dev-haskell/djot-0.2:=[profile?]
	...
	>=dev-haskell/skylighting-0.14.1:=[profile?] <dev-haskell/skylighting-0.15:=[profile?]
	>=dev-haskell/skylighting-core-0.14.1:=[profile?] <dev-haskell/skylighting-core-0.15:=[profile?]
	...
	>=dev-haskell/texmath-0.12.8.6:=[profile?] <dev-haskell/texmath-0.13:=[profile?]
	...
	>=dev-haskell/typst-0.5.0.1:=[profile?] <dev-haskell/typst-0.5.1:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/diff-0.2 <dev-haskell/diff-0.6
