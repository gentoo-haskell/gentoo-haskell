...
RDEPEND=">=dev-haskell/aeson-2.0.1.0:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	...
	>=dev-haskell/citeproc-0.8.1.3:=[profile?] <dev-haskell/citeproc-0.9:=[profile?]
	...
	>=dev-haskell/texmath-0.12.9:=[profile?] <dev-haskell/texmath-0.13:=[profile?]
	...
	>=dev-haskell/typst-0.7:=[profile?] <dev-haskell/typst-0.8:=[profile?]
