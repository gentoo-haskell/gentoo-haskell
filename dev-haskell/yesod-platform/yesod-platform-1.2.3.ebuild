...
RDEPEND=">=dev-haskell/aeson-0.6.1.0:=[profile?]
		...
		>=dev-haskell/entropy-0.2.2.1:=[profile?]
		...
		>=dev-haskell/hamlet-1.1.7.1:=[profile?]
		>=dev-haskell/hjsmin-0.1.4.1:=[profile?]
		>=dev-haskell/hspec-1.6.1:=[profile?]
		...
		>=dev-haskell/http-conduit-1.9.4.1:=[profile?]
		...
		>=dev-haskell/mime-mail-0.4.2:=[profile?]
		...
		>=dev-haskell/persistent-1.2.2.0:=[profile?]
		...
		>=dev-haskell/resourcet-0.4.7.1:=[profile?]
		...
		>=dev-haskell/shakespeare-css-1.0.6.2:=[profile?]
		>=dev-haskell/shakespeare-i18n-1.0.0.3:=[profile?]
		>=dev-haskell/shakespeare-js-1.1.4.1:=[profile?]
		>=dev-haskell/shakespeare-text-1.0.0.6:=[profile?]
		>=dev-haskell/silently-1.2.4.1:=[profile?]
		>=dev-haskell/simple-sendfile-0.2.12:=[profile?]
		>=dev-haskell/skein-1.0.3:=[profile?]
		...
		>=dev-haskell/wai-1.4.0.1:=[profile?]
		>=dev-haskell/wai-app-static-1.3.1.3:=[profile?]
		>=dev-haskell/wai-extra-1.3.4.2:=[profile?]
		>=dev-haskell/wai-logger-0.3.1:=[profile?]
		>=dev-haskell/wai-test-1.3.1.1:=[profile?]
		>=dev-haskell/warp-1.3.9:=[profile?]
		>=dev-haskell/word8-0.0.3:=[profile?]
		>=dev-haskell/xml-conduit-1.1.0.5:=[profile?]
		>=dev-haskell/xml-types-0.3.4:=[profile?]
		>=dev-haskell/xss-sanitize-0.3.4:=[profile?]
		>=dev-haskell/yaml-0.8.4:=[profile?]
		>=dev-haskell/yesod-1.2.1.1:=[profile?]
		>=dev-haskell/yesod-auth-1.2.0.2:=[profile?]
		>=dev-haskell/yesod-core-1.2.3:=[profile?]
		>=dev-haskell/yesod-form-1.3.0.1:=[profile?]
		>=dev-haskell/yesod-persistent-1.2.1:=[profile?]
		>=dev-haskell/yesod-routes-1.2.0.1:=[profile?]
		>=dev-haskell/yesod-static-1.2.0:=[profile?]
		>=dev-haskell/yesod-test-1.2.0:=[profile?]
