...
RDEPEND=">=dev-haskell/aeson-0.6.0.2[profile?]
		...
		>=dev-haskell/authenticate-1.3.0.1[profile?]
		...
		>=dev-haskell/certificate-1.2.4[profile?]
		...
		>=dev-haskell/shakespeare-css-1.0.1.3[profile?]
		>=dev-haskell/shakespeare-i18n-1.0.0.2[profile?]
		>=dev-haskell/shakespeare-js-1.0.0.4[profile?]
		>=dev-haskell/shakespeare-text-1.0.0.3[profile?]
		>=dev-haskell/silently-1.2.0.2[profile?]
		>=dev-haskell/simple-sendfile-0.2.5[profile?]
		...
		>=dev-haskell/yesod-1.1.0[profile?]
		>=dev-haskell/yesod-auth-1.1.0[profile?]
		>=dev-haskell/yesod-core-1.1.0[profile?]
		>=dev-haskell/yesod-default-1.1.0[profile?]
		>=dev-haskell/yesod-form-1.1.0[profile?]
