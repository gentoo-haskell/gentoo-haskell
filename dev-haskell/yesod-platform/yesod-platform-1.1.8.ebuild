...
RDEPEND=">=dev-haskell/aeson-0.6.1.0:=[profile?]
		...
		>=dev-haskell/attoparsec-conduit-1.0.0:=[profile?]
		...
		>=dev-haskell/base64-conduit-1.0.0:=[profile?]
		>=dev-haskell/basic-prelude-0.3.4.0:=[profile?]
		>=dev-haskell/blaze-builder-0.3.1.0:=[profile?]
		>=dev-haskell/blaze-builder-conduit-1.0.0:=[profile?]
		>=dev-haskell/blaze-html-0.6.0.0:=[profile?]
		...
		>=dev-haskell/http-reverse-proxy-0.1.1.3:=[profile?]
		...
		>=dev-haskell/monad-logger-0.3.0.1:=[profile?]
		...
		>=dev-haskell/persistent-1.1.5.1:=[profile?]
		>=dev-haskell/persistent-template-1.1.2.4:=[profile?]
		>=dev-haskell/pool-conduit-0.1.1:=[profile?]
		>=dev-haskell/primitive-0.5.0.1:=[profile?]
		>=dev-haskell/project-template-0.1.3:=[profile?]
		...
		>=dev-haskell/shakespeare-1.0.3.1:=[profile?]
		>=dev-haskell/shakespeare-css-1.0.3:=[profile?]
		>=dev-haskell/shakespeare-i18n-1.0.0.2:=[profile?]
		>=dev-haskell/shakespeare-js-1.1.2.1:=[profile?]
		>=dev-haskell/shakespeare-text-1.0.0.5:=[profile?]
		>=dev-haskell/silently-1.2.4.1:=[profile?]
		>=dev-haskell/simple-sendfile-0.2.11:=[profile?]
		>=dev-haskell/skein-0.1.0.12:=[profile?]
		>=dev-haskell/socks-0.5.0:=[profile?]
		>=dev-haskell/split-0.2.1.2:=[profile?]
		...
		>=dev-haskell/wai-1.4.0:=[profile?]
		>=dev-haskell/wai-app-static-1.3.1.2:=[profile?]
		>=dev-haskell/wai-extra-1.3.2.4:=[profile?]
		>=dev-haskell/wai-logger-0.3.0:=[profile?]
		>=dev-haskell/wai-test-1.3.0.4:=[profile?]
		>=dev-haskell/warp-1.3.7.4:=[profile?]
		>=dev-haskell/word8-0.0.3:=[profile?]
		>=dev-haskell/xml-conduit-1.1.0.3:=[profile?]
		>=dev-haskell/xml-types-0.3.3:=[profile?]
		>=dev-haskell/xss-sanitize-0.3.3:=[profile?]
		>=dev-haskell/yaml-0.8.2.3:=[profile?]
		>=dev-haskell/yesod-1.1.9.2:=[profile?]
		>=dev-haskell/yesod-auth-1.1.5.3:=[profile?]
		>=dev-haskell/yesod-core-1.1.8.2:=[profile?]
		>=dev-haskell/yesod-default-1.1.3.2:=[profile?]
		>=dev-haskell/yesod-form-1.2.1.3:=[profile?]
		>=dev-haskell/yesod-json-1.1.2.1:=[profile?]
		>=dev-haskell/yesod-persistent-1.1.0.1:=[profile?]
		>=dev-haskell/yesod-routes-1.1.2:=[profile?]
		>=dev-haskell/yesod-static-1.1.2.2:=[profile?]
		>=dev-haskell/yesod-test-0.3.5:=[profile?]
