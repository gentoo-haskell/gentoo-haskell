...
RDEPEND="~dev-haskell/aeson-0.7.0.0:=[profile?]
	~dev-haskell/ansi-terminal-0.6.1:=[profile?]
	...
	~dev-haskell/cipher-blowfish-0.0.3:=[profile?]
	~dev-haskell/cipher-camellia-0.0.2:=[profile?]
	~dev-haskell/cipher-des-0.0.6:=[profile?]
	~dev-haskell/cipher-rc4-0.1.4:=[profile?]
	~dev-haskell/clientsession-0.9.0.3:=[profile?]
	~dev-haskell/conduit-1.0.11.1:=[profile?]
	...
	~dev-haskell/cryptocipher-0.6.2:=[profile?]
	...
	~dev-haskell/esqueleto-1.3.4.3:=[profile?]
	...
	~dev-haskell/hamlet-1.1.7.6:=[profile?]
	...
	~dev-haskell/http-attoparsec-0.1.1:=[profile?]
	~dev-haskell/http-client-0.2.1:=[profile?]
	~dev-haskell/http-client-conduit-0.2.0.1:=[profile?]
	~dev-haskell/http-client-tls-0.2.0.2:=[profile?]
	~dev-haskell/http-conduit-2.0.0.3:=[profile?]
	...
	~dev-haskell/wai-extra-2.0.3:=[profile?]
	~dev-haskell/wai-logger-2.1.1:=[profile?]
	~dev-haskell/wai-test-2.0.0.1:=[profile?]
	~dev-haskell/warp-2.0.2:=[profile?]
	~dev-haskell/warp-tls-2.0.1:=[profile?]
	...
	~dev-haskell/yaml-0.8.5.3:=[profile?]
	~dev-haskell/yesod-1.2.4:=[profile?]
	~dev-haskell/yesod-auth-1.2.5.3:=[profile?]
	~dev-haskell/yesod-core-1.2.6.5:=[profile?]
	~dev-haskell/yesod-form-1.3.4.3:=[profile?]
