...
RDEPEND=">=dev-haskell/aeson-0.6.2.1:=[profile?]
	...
	>=dev-haskell/fast-logger-2.1.0:=[profile?]
	...
	>=dev-haskell/persistent-1.3.0:=[profile?]
	>=dev-haskell/persistent-template-1.3.0:=[profile?]
	...
	>=dev-haskell/wai-extra-2.0.1.2:=[profile?]
	>=dev-haskell/wai-logger-2.1.0:=[profile?]
	...
	>=dev-haskell/xss-sanitize-0.3.4.1:=[profile?]
	>=dev-haskell/yaml-0.8.5.2:=[profile?]
	>=dev-haskell/yesod-1.2.4:=[profile?]
	>=dev-haskell/yesod-auth-1.2.5.2:=[profile?]
	>=dev-haskell/yesod-core-1.2.6.4:=[profile?]
	>=dev-haskell/yesod-form-1.3.4.2:=[profile?]
	>=dev-haskell/yesod-persistent-1.2.2.1:=[profile?]
	>=dev-haskell/yesod-routes-1.2.0.5:=[profile?]
