...
RDEPEND=">=dev-haskell/aeson-0.6.0.2[profile?]
		...
		>=dev-haskell/void-0.5.6[profile?]
		>=dev-haskell/wai-1.2.0.3[profile?]
		>=dev-haskell/wai-app-static-1.2.0.4[profile?]
		>=dev-haskell/wai-extra-1.2.0.5[profile?]
		>=dev-haskell/wai-logger-0.1.4[profile?]
		>=dev-haskell/wai-test-1.2.0.2[profile?]
		>=dev-haskell/warp-1.2.2[profile?]
		>=dev-haskell/xml-conduit-0.7.0.3[profile?]
		>=dev-haskell/xml-types-0.3.2[profile?]
		>=dev-haskell/xml2html-0.1.2.3[profile?]
		>=dev-haskell/xss-sanitize-0.3.2[profile?]
		>=dev-haskell/yaml-0.7.0.3[profile?]
		...
		>=dev-haskell/yesod-test-0.2.1[profile?]
		>=dev-haskell/zlib-0.5.3.3[profile?]
		>=dev-haskell/zlib-bindings-0.1.0.1[profile?]
		>=dev-haskell/zlib-conduit-0.4.0.2[profile?]
		>=dev-lang/ghc-6.10.1"
DEPEND="${RDEPEND}
