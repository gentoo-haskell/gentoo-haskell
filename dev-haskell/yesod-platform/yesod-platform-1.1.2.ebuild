...
RDEPEND=">=dev-haskell/aeson-0.6.0.2[profile?]
		...
		>=dev-haskell/attoparsec-conduit-0.5.0.1[profile?]
		...
		>=dev-haskell/certificate-1.2.6[profile?]
		...
		>=dev-haskell/http-conduit-1.6.0.3[profile?]
		...
		>=dev-haskell/monad-logger-0.2.0.1[profile?]
		>=dev-haskell/network-conduit-0.5.0.1[profile?]
		>=dev-haskell/path-pieces-0.1.1[profile?]
		>=dev-haskell/pem-0.1.1[profile?]
		>=dev-haskell/persistent-1.0.1.1[profile?]
		>=dev-haskell/persistent-template-1.0.0.1[profile?]
		...
		>=dev-haskell/shakespeare-1.0.1.3[profile?]
		...
		>=dev-haskell/tagstream-conduit-0.5.2[profile?]
		>=dev-haskell/tar-0.4.0.0[profile?]
		>=dev-haskell/tls-0.9.10[profile?]
		...
		>=dev-haskell/wai-app-static-1.3.0.1[profile?]
		>=dev-haskell/wai-extra-1.3.0.1[profile?]
		>=dev-haskell/wai-logger-0.3.0[profile?]
		>=dev-haskell/wai-test-1.3.0[profile?]
		>=dev-haskell/warp-1.3.1[profile?]
		...
		>=dev-haskell/yesod-1.1.0.3[profile?]
		>=dev-haskell/yesod-auth-1.1.1.1[profile?]
		>=dev-haskell/yesod-core-1.1.1.2[profile?]
		>=dev-haskell/yesod-default-1.1.0[profile?]
		>=dev-haskell/yesod-form-1.1.1.1[profile?]
