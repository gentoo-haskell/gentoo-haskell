...
RDEPEND=">=dev-haskell/aeson-0.6.0.2[profile?]
		...
		>=dev-haskell/conduit-0.5.2.4[profile?]
		...
		>=dev-haskell/file-embed-0.0.4.5[profile?]
		...
		>=dev-haskell/http-conduit-1.6.1[profile?]
		...
		>=dev-haskell/network-conduit-0.5.0.2[profile?]
		>=dev-haskell/path-pieces-0.1.2[profile?]
		>=dev-haskell/pem-0.1.1[profile?]
		>=dev-haskell/persistent-1.0.1.2[profile?]
		...
		>=dev-haskell/resourcet-0.4.0.1[profile?]
