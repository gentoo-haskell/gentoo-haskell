...
RDEPEND=">=dev-haskell/base64-bytestring-0.1:=[profile?] <dev-haskell/base64-bytestring-1.1:=[profile?]
	...
	>=dev-haskell/happstack-server-6.4:=[profile?] <dev-haskell/happstack-server-7.5:=[profile?]
	...
	>=dev-haskell/wl-pprint-text-1.1:=[profile?] <dev-haskell/wl-pprint-text-1.2:=[profile?]
	>=dev-lang/ghc-7.4.1:=
"
DEPEND="${RDEPEND}
