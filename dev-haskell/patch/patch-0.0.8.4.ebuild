...
RDEPEND="
	>=dev-haskell/commutative-semigroups-0.0:=[profile?] <dev-haskell/commutative-semigroups-0.3:=[profile?]
	...
	>=dev-haskell/witherable-0.3:=[profile?] <dev-haskell/witherable-0.6:=[profile?]
	>=dev-lang/ghc-9.0.2:=
"
DEPEND="${RDEPEND}
