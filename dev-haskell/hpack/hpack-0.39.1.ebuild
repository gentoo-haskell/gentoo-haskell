...
GIT_COMMIT="c38a5c4edaa93b8ed6cd7820f563be596b4fe128" # tag 0.39.1
GIT_P="${PN}-${GIT_COMMIT}"
...
PATCHES=(
	"${FILESDIR}/${PN}-0.39.1-add-executable-flag.patch"
)

RDEPEND=">=dev-haskell/aeson-1.4.3.0:=[profile?]
	dev-haskell/bifunctors:=[profile?]
	>=dev-haskell/cabal-3.0.0.0:=[profile?] <dev-haskell/cabal-3.17:=[profile?]
