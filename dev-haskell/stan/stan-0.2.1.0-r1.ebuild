...
SLOT="0/${PV}"
KEYWORDS="~amd64"
IUSE="+directory-ospath-streaming"

CABAL_CHDEPS=(
	'hedgehog >= 1.0 && < 1.6' 'hedgehog >= 1.0'
)
...
RDEPEND=">=dev-haskell/base64-0.4.1:=[profile?] <dev-haskell/base64-1.1:=[profile?]
	...
	>=dev-haskell/clay-0.14:=[profile?] <dev-haskell/clay-0.17:=[profile?]
	...
	>=dev-haskell/optparse-applicative-0.15:=[profile?] <dev-haskell/optparse-applicative-0.20:=[profile?]
	...
	>=dev-haskell/slist-0.1:=[profile?] <dev-haskell/slist-0.4:=[profile?]
...
src_configure() {
	haskell-cabal_src_configure \
		$(cabal_flag directory-ospath-streaming directory-ospath-streaming)
}
