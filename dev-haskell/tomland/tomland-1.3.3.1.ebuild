...
RDEPEND=">=dev-haskell/hashable-1.3.1.0:=[profile?] <dev-haskell/hashable-1.5:=[profile?]
...
DEPEND="${RDEPEND}
	...
	example-readme? ( dev-haskell/markdown-unlit )
"

src_prepare() {
	default

	# Rename 'readme' example executable
	cabal_chdeps \
		'executable readme' 'executable tomland-readme' \
		'hspec >= 2.7.1 && < 2.9' 'hspec >= 2.7.1'
}
