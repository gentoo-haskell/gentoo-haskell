...
RDEPEND=">dev-haskell/aeson-0.6:=[profile?] <dev-haskell/aeson-0.11:=[profile?]
	>=dev-haskell/base-compat-0.8:=[profile?] <dev-haskell/base-compat-0.9:=[profile?]
	...
	<dev-haskell/traverse-with-class-0.3:=[profile?]
	<dev-haskell/type-eq-0.6:=[profile?]
	...
	test? ( dev-haskell/attoparsec:=[profile?]
		...
		>=dev-haskell/tasty-0.9:=[profile?] <dev-haskell/tasty-0.12:=[profile?]
