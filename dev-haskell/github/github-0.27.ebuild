...
RDEPEND=">=dev-haskell/base-compat-0.11.1:=[profile?] <dev-haskell/base-compat-0.13:=[profile?]
	...
	>=dev-lang/ghc-8.10.1:=
	>=dev-haskell/aeson-1.4.0.0:=[profile?] <dev-haskell/aeson-2.1:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( dev-haskell/aeson
		...
		>=dev-haskell/hspec-2.6.1 <dev-haskell/hspec-2.10 )
"
