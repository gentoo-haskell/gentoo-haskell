...
RDEPEND="dev-haskell/aeson:=[profile?]
	...
	>=dev-haskell/cabal-3:=[profile?] <dev-haskell/cabal-3.15:=[profile?]
	>=dev-haskell/casa-client-0.0.2:=[profile?]
	dev-haskell/casa-types:=[profile?]
	dev-haskell/companion:=[profile?]
	dev-haskell/conduit:=[profile?]
	dev-haskell/conduit-extra:=[profile?]
	dev-haskell/crypton:=[profile?]
	dev-haskell/crypton-conduit:=[profile?]
	...
	>=dev-haskell/hpack-0.35.3:=[profile?]
	...
	>=dev-haskell/static-bytes-0.1.1:=[profile?]
	>=dev-haskell/tar-conduit-0.4.1:=[profile?]
