...
RDEPEND=">=dev-haskell/hashable-1.1.2.3:=[profile?] <dev-haskell/hashable-1.3:=[profile?]
	>=dev-haskell/microlens-0.4.8:=[profile?] <dev-haskell/microlens-0.4.9:=[profile?]
	>=dev-haskell/microlens-ghc-0.4.8:=[profile?] <dev-haskell/microlens-ghc-0.4.9:=[profile?]
