...
RDEPEND=">=dev-haskell/hashable-1.1.2.3:=[profile?] <dev-haskell/hashable-1.3:=[profile?]
	>=dev-haskell/microlens-0.4.6:=[profile?] <dev-haskell/microlens-0.4.7:=[profile?]
	>=dev-haskell/microlens-ghc-0.4.6:=[profile?] <dev-haskell/microlens-ghc-0.4.7:=[profile?]
	>=dev-haskell/microlens-mtl-0.1.9:=[profile?] <dev-haskell/microlens-mtl-0.1.10:=[profile?]
