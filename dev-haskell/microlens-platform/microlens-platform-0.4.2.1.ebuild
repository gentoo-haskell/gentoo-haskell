...
RDEPEND=">=dev-haskell/hashable-1.1.2.3:=[profile?] <dev-haskell/hashable-1.5:=[profile?]
	>=dev-haskell/microlens-0.4.12:=[profile?] <dev-haskell/microlens-0.4.13:=[profile?]
	>=dev-haskell/microlens-ghc-0.4.13:=[profile?] <dev-haskell/microlens-ghc-0.4.14:=[profile?]
