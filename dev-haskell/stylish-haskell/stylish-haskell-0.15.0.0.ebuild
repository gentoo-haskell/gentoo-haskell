...
CABAL_CHDEPS=(
	'ghc-lib-parser >= 9.10 && < 9.11' 'ghc-lib-parser >= 9.12 && < 9.13'
	'ghc-lib-parser-ex >= 9.10 && < 9.11' 'ghc-lib-parser-ex >= 9.12 && < 9.13'
	)

PATCHES=(
	"${FILESDIR}"/${P}-ghc-lib-parser-9.12.patch
	"${FILESDIR}"/${P}-cabal-3.12.patch
)

RDEPEND=">=dev-haskell/aeson-0.6:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	>=dev-haskell/cabal-3.10:=[profile?] <dev-haskell/cabal-4.0:=[profile?]
