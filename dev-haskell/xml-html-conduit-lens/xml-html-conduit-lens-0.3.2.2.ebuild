...
RESTRICT=test # sime files are missing
...
RDEPEND=">=dev-haskell/html-conduit-1.1:=[profile?] <dev-haskell/html-conduit-1.3:=[profile?]
	...
	>=dev-haskell/xml-conduit-1.1:=[profile?] <dev-haskell/xml-conduit-1.5:=[profile?]
	>=dev-lang/ghc-7.4.1:=
"
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/doctest-0.9.10
		...
		>=dev-haskell/xml-conduit-1.1 <dev-haskell/xml-conduit-1.4 )
"
