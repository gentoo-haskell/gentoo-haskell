...
RDEPEND="dev-haskell/aeson:=[profile?]
	...
	>=dev-haskell/pandoc-3.2.1:=[profile?] <dev-haskell/pandoc-3.3:=[profile?]
	>=dev-haskell/pandoc-lua-marshal-0.2.7:=[profile?] <dev-haskell/pandoc-lua-marshal-0.3:=[profile?]
