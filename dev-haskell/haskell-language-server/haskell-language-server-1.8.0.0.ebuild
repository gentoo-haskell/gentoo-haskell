...
#hackport: flags: brittany:hls_formatters_brittany,floskell:hls_formatters_floskell,fourmolu:hls_formatters_fourmolu,ormolu:hls_formatters_ormolu,refactor:hls_formatters_refactor,stylishhaskell:hls_formatters_stylish-haskell,alternateNumberFormat:hls_plugins_alternate-number-format,callHierarchy:hls_plugins_call-hierarchy,changeTypeSignature:hls_plugins_change-type-signature,class:hls_plugins_class,codeRange:hls_plugins_code-range,eval:hls_plugins_eval,explicitFixity:hls_plugins_explicit-fixity,gadt:hls_plugins_gadt,haddockComments:hls_plugins_haddock-comments,hlint:hls_plugins_hlint,importLens:hls_plugins_import-lens,moduleName:hls_plugins_module-name,pragmas:hls_plugins_pragmas,qualifyImportedNames:hls_plugins_qualify-imported-names,refineImports:hls_plugins_refine-imports,rename:hls_plugins_rename,retrie:hls_plugins_retrie,splice:hls_plugins_splice,tactic:hls_plugins_wingman,-dynamic,+ignore-plugins-ghc-bounds,-pedantic,-stan
...
RDEPEND="
	...
	hls_formatters_refactor? ( >=dev-haskell/hls-refactor-plugin-1.0:=[profile?] <dev-haskell/hls-refactor-plugin-1.1:=[profile?] )
	...
	hls_plugins_alternate-number-format? ( >=dev-haskell/hls-alternate-number-format-plugin-1.2:=[profile?] <dev-haskell/hls-alternate-number-format-plugin-1.3:=[profile?] )
	...
	hls_plugins_change-type-signature? ( >dev-haskell/hls-change-type-signature-plugin-1.0.1.0 <dev-haskell/hls-change-type-signature-plugin-1.1 )
	hls_plugins_class? ( >=dev-haskell/hls-class-plugin-1.1:=[profile?] <dev-haskell/hls-class-plugin-1.2:=[profile?] )
	hls_plugins_code-range? ( >=dev-haskell/hls-code-range-plugin-1.0.0.0:=[profile?] <dev-haskell/hls-code-range-plugin-1.1:=[profile?] )
	hls_plugins_eval? ( >=dev-haskell/hls-eval-plugin-1.3:=[profile?] <dev-haskell/hls-eval-plugin-1.4:=[profile?] )
	hls_plugins_explicit-fixity? ( >=dev-haskell/hls-explicit-fixity-plugin-1.0:=[profile?] <dev-haskell/hls-explicit-fixity-plugin-1.1:=[profile?] )
	...
	hls_plugins_wingman? ( >=dev-haskell/hls-tactics-plugin-1.7:=[profile?] <dev-haskell/hls-tactics-plugin-1.8:=[profile?] )
"
