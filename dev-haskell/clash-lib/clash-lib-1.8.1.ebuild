...
SLOT="0/${PV}"
KEYWORDS="~amd64"
IUSE="debug +unittests workaround-ghc-mmap-crash"
...
RDEPEND=">=dev-haskell/aeson-0.6.2.0:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	...
	>=dev-haskell/ansi-terminal-0.8.0.0:=[profile?] <dev-haskell/ansi-terminal-1.1:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( unittests? ( dev-haskell/clash-prelude
