...
RDEPEND=">=dev-haskell/aeson-2.2.0.0:=[profile?]
	>=dev-haskell/attoparsec-0.11:=[profile?] <dev-haskell/attoparsec-0.15:=[profile?]
	>=dev-haskell/attoparsec-aeson-2.1.0.0:=[profile?]
	...
	>=dev-haskell/data-default-0.5.3:=[profile?] <dev-haskell/data-default-0.9:=[profile?]
