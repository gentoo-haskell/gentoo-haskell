...
src_install() {
	...
	# Cabal installs the bash completion in /usr/share/bash-completion/
	# in contrast to the previous makefiles that installed into 
	# /etc/bash_completion.d/ . Fixes bug #148038.
}
