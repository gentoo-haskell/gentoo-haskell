...
src_unpack() {
	...
	# This patch makes sure the use of type witnesses is not changed when the
	# docs are enabled/disabled. This was an issue in #210046.
	cd "${S}"
	epatch "${FILESDIR}/${P}-type-witnesses.patch"
	...
	echo "Gentoo ${PVR}" > "${S}/release/STATE"
