...
RDEPEND=">=dev-haskell/aeson-0.7.0:=[profile?]
	...
	>=dev-haskell/haddock-api-2.16.0:=[profile?] <dev-haskell/haddock-api-2.18.0:=[profile?]
	>=dev-haskell/haddock-library-1.2:=[profile?] <dev-haskell/haddock-library-1.5:=[profile?]
