...
RESTRICT="test" # Error: fd:33: hPutBuf: resource vanished (Broken pipe)
...
RDEPEND="dev-haskell/aeson:=[profile?]
	...
	hls_plugins_tactics? ( >=dev-haskell/hls-tactics-plugin-1.2.0.0:=[profile?] <dev-haskell/hls-tactics-plugin-1.6:=[profile?] )
"
...
#		>=dev-haskell/hls-test-utils-1.1.0.0 <dev-haskell/hls-test-utils-1.2
#		dev-haskell/hspec-expectations
#		dev-haskell/lsp-test
#		dev-haskell/lsp-types )"

src_prepare() {
	ghc-supports-threaded-runtime && eapply "${FILESDIR}/${PN}-1.4.0.0-add-paralellism-rtsopts.patch"
	default
}
