...
#hackport: external-depends: rdepend:sys-apps/pkgcore

CABAL_FEATURES="lib profile haddock hoogle hscolour"
EGIT_REPO_URI="https://github.com/gentoo-haskell/random-build"
...
RDEPEND=">=dev-haskell/async-2.2.5:=[profile?] <dev-haskell/async-2.3:=[profile?]
	...
	>=dev-haskell/portage-hs-9999:=[profile?]
