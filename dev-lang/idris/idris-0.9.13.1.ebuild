...
RDEPEND="curses? ( dev-haskell/hscurses:=[profile?] )
	ffi? ( curses? ( >=dev-haskell/annotated-wl-pprint-0.5.3:=[profile?]
				...
				>=dev-lang/ghc-7.6.1:= )
		!curses? ( !gmp? ( >=dev-haskell/annotated-wl-pprint-0.5.3:=[profile?]
					dev-haskell/ansi-terminal:=[profile?]
					dev-haskell/ansi-wl-pprint:=[profile?]
					dev-haskell/binary:=[profile?]
					>=dev-haskell/blaze-html-0.6.1.3:=[profile?]
					...
					dev-haskell/zlib:=[profile?]
					>=dev-lang/ghc-7.6.1:= ) ) )
	!ffi? ( !gmp? ( >=dev-haskell/annotated-wl-pprint-0.5.3:=[profile?]
			dev-haskell/ansi-terminal:=[profile?]
			dev-haskell/ansi-wl-pprint:=[profile?]
			dev-haskell/binary:=[profile?]
			>=dev-haskell/blaze-html-0.6.1.3:=[profile?]
			...
			dev-haskell/zlib:=[profile?]
			>=dev-lang/ghc-7.6.1:= ) )
	gmp? ( >=dev-haskell/annotated-wl-pprint-0.5.3:=[profile?]
		dev-haskell/ansi-terminal:=[profile?]
		dev-haskell/ansi-wl-pprint:=[profile?]
		dev-haskell/binary:=[profile?]
		>=dev-haskell/blaze-html-0.6.1.3:=[profile?]
		...
		dev-haskell/zlib:=[profile?]
		>=dev-lang/ghc-7.6.1:= )
	llvm? ( ffi? ( curses? ( >=dev-haskell/llvm-general-3.3.8:=[profile?] <dev-haskell/llvm-general-3.3.9:=[profile?]
					>=dev-haskell/llvm-general-pure-3.3.8:=[profile?] <dev-haskell/llvm-general-pure-3.3.9:=[profile?] )
			!curses? ( !gmp? ( >=dev-haskell/llvm-general-3.3.8:=[profile?] <dev-haskell/llvm-general-3.3.9:=[profile?]
						>=dev-haskell/llvm-general-pure-3.3.8:=[profile?] <dev-haskell/llvm-general-pure-3.3.9:=[profile?] ) ) )
		!ffi? ( !gmp? ( >=dev-haskell/llvm-general-3.3.8:=[profile?] <dev-haskell/llvm-general-3.3.9:=[profile?]
				>=dev-haskell/llvm-general-pure-3.3.8:=[profile?] <dev-haskell/llvm-general-pure-3.3.9:=[profile?] ) )
		gmp? ( >=dev-haskell/llvm-general-3.3.8:=[profile?] <dev-haskell/llvm-general-3.3.9:=[profile?]
			>=dev-haskell/llvm-general-pure-3.3.8:=[profile?] <dev-haskell/llvm-general-pure-3.3.9:=[profile?] ) )
"
DEPEND="${RDEPEND}
