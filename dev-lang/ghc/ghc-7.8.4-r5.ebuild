...
arch_binaries="$arch_binaries amd64? ( http://code.haskell.org/~slyfox/ghc-amd64/ghc-bin-${PV}-amd64-r4.tbz2 )"
...
arch_binaries="$arch_binaries x86? ( http://code.haskell.org/~slyfox/ghc-x86/ghc-bin-${PV}-x86-r4.tbz2 )"
...
BUMP_LIBRARIES=(
	"binary          0.7.4.0"    # latest 0.7.* on hackage
	"transformers    0.4.3.0"    # latest 0.4.* on hackage
