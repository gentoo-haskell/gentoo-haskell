...
RDEPEND=">=dev-haskell/aeson-1.0:=[profile?] <dev-haskell/aeson-1.1:=[profile?]
	...
	>=dev-haskell/blaze-html-0.8.1:=[profile?] <dev-haskell/blaze-html-0.9:=[profile?]
	...
	>=dev-haskell/pipes-4.0.0:=[profile?] <dev-haskell/pipes-4.4.0:=[profile?]
	...
	>=dev-haskell/websockets-0.9:=[profile?] <dev-haskell/websockets-0.11:=[profile?]
	>=dev-lang/ghc-7.10.1:=
"
DEPEND="${RDEPEND}
